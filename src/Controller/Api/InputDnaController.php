...
class InputDnaController extends AppController
{
    public function initialize()
    {
        ...
        $this->CurrentModel = $this->InputDna;
    }
    ...
    private function zerotoNull($entity){
        if ($entity['numtubent'] == 0) $entity['numtubent'] = null;
        if ($entity['tipdep'] == 0) $entity['tipdep'] = null;
        if ($entity['tipmuestra'] == 0) $entity['tipmuestra'] = null;
        if ($entity['estmuestra'] == 0) $entity['estmuestra'] = null;
