...
class ShortTermConservationMicroController extends AppController
{
    ...
    {
        parent::initialize();
        $this->loadModel('ShortTermConservationMicro');
        $this->CurrentModel = $this->ShortTermConservationMicro;
    ...
    public function index()
    {
        ...
        $data = $this->ShortTermConservationMicro->find('all')->where($params)->toArray();
    ...
    public function add()
    {
        ...
        if (!$result_entity) {
            ...
            return $this->Functions->api_error($this->response,'No se puede agregar La conservacion a Corto Plazo',[]);
        }
    ...
    public function edit($id='')
    {
        ...
        if (!$result_entity) {
            return $this->Functions->api_error($this->response,'No se puede editar La conservacion a Corto Plazo',[]);
        }
        return $this->view($id);
    }
