...
class OutputFieldController extends AppController
{
    public function initialize()
    {
        ...
        $this->CurrentModel = $this->OutputField;
    }
    ...
    private function zerotoNull($entity){
        ...
        if ($entity['samptype'] == 0) $entity['samptype'] = null;
        if ($entity['samplamount'] == 0) $entity['samplamount'] = null;
