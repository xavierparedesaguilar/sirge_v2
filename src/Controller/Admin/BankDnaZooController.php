 ...
 */
class BankDnaZooController extends AppController
{
    ...
    public function index()
    {
        if($this->permiso['index']){
            ...
            $bankDna = $this->BankDna->find()
                                             ...
                                             ->where(['BankDna.status !=' => '0','BankDna.type_resource '=>'2']);
    ...
    public function view($id = null)
    {
        if($this->permiso['view']){
            ...
            $bankDna = $this->BankDna->find()->contain('Passport.Specie.Collection')
                                             ->leftJoinWith('Passport.Specie.Collection')
                                             ->where(['BankDna.status !=' => '0','BankDna.id '=>$id,'BankDna.type_resource '=>2])->first();
            ...
            if ($this->request->is('post')) {
                ...
                try{
                    ...
                    if( $data['passport_id']!=null || $data['passport_id']!=''){
                        if ($this->BankDna->save($bankDna)) {
                            ...
                            if ($this->BankDna->save($bankDna_update)) {
                              ...
                              return $this->redirect(['controller' => 'ExtractionDnaZoo', 'action' => 'add',$bankDna->id]);
                            }
                        }
                    }
                    ...
                    $this->Flash->error(__('Hubo inconvenientes al crear el Banco ADN. Por favor, Otra vez intente.'));
                        ...
                        $this->Flash->error(__('Hubo inconvenientes al crear el Banco ADN. Por favor, Otra vez intente.'.$e->getMessage()));
                        return $this->redirect(['action' => 'index']);
                }
            }
    ...
    public function edit($id = null)
    {
        ...
        $bankDna =$this->BankDna->find()->contain('Passport')
                                             ...
                                             ->where(['Passport.status' => '1','BankDna.id'=>$id,'Passport.resource_id' => 2,'BankDna.type_resource'=>2])->first();
        ...
        if($this->permiso['edit'] /*&& $validar*/){
            ...
            $passport =$this->Passport->find()->contain('Specie.Collection')
                                             ...
                                             ->where(['Passport.status' => '1', 'Passport.resource_id' => 2,'Passport.id'=>$bankDna->passport_id])->first();
                ...
                try{
                    ...
                    if ($this->BankDna->save($bankDna)) {
                        ...
                        if($extractionDna!=null)
                            return $this->redirect(['controller' => 'ExtractionDnaZoo', 'action' => 'edit',$bankDna->id]);
    ...
    public function delete($id = null)
    {
        ...
        if( $this->permiso['delete'] /*&& $validar*/ ){
            ...
            if($bankDna_count>0){
                ...
                $bankDna = $this->BankDna->find()
                                             ->where(['BankDna.status !=' => '0','BankDna.id'=>$id,'BankDna.type_resource '=>2
                                                ])->first()  ;
