 ...
 */
class OutputDnaZooController extends AppController
{
    ...
    public function delete($id = null,$child=null)
    {
        ...
        if($bankDna_count!=NULL && $this->permiso['delete'] /*&& $validar*/ ){
            ...
            $outputDnaZoo = $this->OutputDna->find()
                                         ->where(['OutputDna.status !=' => '0','OutputDna.id'=>$child,'OutputDna.bank_dna_id'=>$id
                                            ])->first();

            if($outputDnaZoo==NULL){

                $this->Flash->error(__('Operación denegada.'));
                return $this->redirect(['action' => 'index',$id]);
            }else{

                $outputDnaZoo['status'] = 0;

                if ($this->OutputDna->save($outputDnaZoo)) {
               ...
               return $this->redirect(['action' => 'index', $outputDnaZoo->bank_dna_id]);
            }
