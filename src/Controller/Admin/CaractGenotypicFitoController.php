 ...
 */
class CaractGenotypicFitoController extends AppController
{
    ...
    public function index()
    {
        ...
        if($this->permiso['index']){
            ...
            $caractGenotypic = $this->CaractGenotypic->find()->where(['status' => '1', 'resource_id' => 1])->all();
    ...
    public function view($id = null)
    {
        ...
        if($this->permiso['view']){
            ...
            $caractGenotypic = $this->CaractGenotypic->find()->where(['CaractGenotypic.status' => '1','CaractGenotypic.id '=>$id,'   CaractGenotypic.resource_id '=>1])->first();
    ...
    public function add()
    {
        ...
        if($this->permiso['add']){
                ...
                if ($this->request->is(['patch', 'post', 'put'])) {
                    ...
                    $data['CaractGenotypic']['resource_id'] = '1';
                    ...
                    /********* ARCHIVO 1 *********/
                    $data['file_1']['name'] =  'accenumb_'.$caractGenotypic->numeroDocumentoFito.$extension;
                    $fichero_subido_1 = $dir_subida . basename($data['file_1']['name']);
                    if(move_uploaded_file($data['file_1']['tmp_name'], $fichero_subido_1))
                        $data['CaractGenotypic']['accenumb'] = 'pass_fitogenetico/genotipica/'. 'accenumb_'.$caractGenotypic->numeroDocumentoFito.$extension;

                    /********* ARCHIVO 2 *********/
                    $data['file_2']['name'] =  'datamatrix_'.$caractGenotypic->numeroDocumentoFito.$extension_;
                    $fichero_subido_2 = $dir_subida . basename($data['file_2']['name']);
                    if(move_uploaded_file($data['file_2']['tmp_name'], $fichero_subido_2))
                        $data['CaractGenotypic']['datamatrix'] = 'pass_fitogenetico/genotipica/'. 'datamatrix_'.$caractGenotypic->numeroDocumentoFito.$extension_;
                    ...
                    $this->Flash->error(__('Hubo inconvenientes al crear la Caracterización Genotípica. Por favor, Otra vez intente.'));
                }
                ...
                $marcador_molecular = $this->OptionList->find('list', ['keyField' => 'id', 'valueField' => 'name'])->where(['status' => 1, 'parent_id' => 421, 'OR' => [['resource_id' => 1], ['resource_id' => 4]] ]);
                $localizacion       = $this->OptionList->find('list', ['keyField' => 'id', 'valueField' => 'name'])->where(['status' => 1, 'parent_id' => 422, 'OR' => [['resource_id' => 1], ['resource_id' => 4]] ]);
    ...
    public function edit($id = null)
    {
        ...
        if($this->permiso['edit']){
                ...
                $caractGenotypic =$this->CaractGenotypic->find()->where(['CaractGenotypic.status' => '1', 'CaractGenotypic.resource_id' => 1,'CaractGenotypic.id'=>$id])->first();
                ...
                if($caractGenotypic!=NULL){
                        ...
                        if ($this->request->is(['patch', 'post', 'put'])) {
                            ...
                            $fichero_subido_1 = $dir_subida . basename($data['file_1']['name']);
                            if(move_uploaded_file($data['file_1']['tmp_name'], $fichero_subido_1))
                                $data['CaractGenotypic']['accenumb'] = 'pass_fitogenetico/genotipica/'. 'accenumb_'.$caractGenotypic->expnumb.$extension;

                            /********* ARCHIVO 2 *********/
                            $data['file_2']['name'] =  'datamatrix_'.$caractGenotypic->expnumb.$extension_;
                            $fichero_subido_2 = $dir_subida . basename($data['file_2']['name']);
                            if(move_uploaded_file($data['file_2']['tmp_name'], $fichero_subido_2))
                                $data['CaractGenotypic']['datamatrix'] = 'pass_fitogenetico/genotipica/'. 'datamatrix_'.$caractGenotypic->expnumb.$extension_;
