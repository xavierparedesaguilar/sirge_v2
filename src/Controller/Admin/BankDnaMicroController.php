 ...
 */
class BankDnaMicroController extends AppController
{
    ...
    public function index()
    {
         ...
         if($this->permiso['index']){
            ...
            $bankDna = $this->BankDna->find()
                                             ...
                                             ->where(['BankDna.status !=' => '0','BankDna.type_resource '=>'3']);
    ...
    public function view($id = null)
    {
        ...
        if($this->permiso['view']){
            ...
            $bankDna = $this->BankDna->find()->contain('Passport.Specie.Collection')
                                             ->leftJoinWith('Passport.Specie.Collection')
                                             ->where(['BankDna.status !=' => '0','BankDna.id '=>$id,'BankDna.type_resource '=>3])->first();
          $validar=$this->permiso['role_id']==1?true:$this->permiso['station_id']==$bankDna->passport->station_current_id;
            ...
            if($bankDna ==NULL){
                ...
                $this->set(compact('bankDna', 'titulo', 'parent','extractionDna','id','permiso','validar'));
                $this->set('_serialize', ['bankDna']);
    ...
    public function add()
    {
        ...
        if($this->permiso['add']){
                    ...
                    if( $data['passport_id']!=null || $data['passport_id']!=''){
                        ...
                        if ($this->BankDna->save($bankDna)) {
                           ...
                           if ($this->BankDna->save($bankDna_update)) {
                                ...
                                return $this->redirect(['controller' => 'ExtractionDnaMicro', 'action' => 'add',$bankDna->id]);
            ...
            $this->set(compact('scripts','bankDna', 'modulo','tipo_disponibilidad'));
    ...
    public function edit($id = null)
    {
        ...
        $bankDna =$this->BankDna->find()->contain('Passport')
                                             ...
                                             ->where(['Passport.status' => '1', 'Passport.resource_id' => 3,'BankDna.id'=>$id,'BankDna.type_resource'=>3])->first();
        ...
        if($this->permiso['edit'] /*&& $validar*/){
            ...
            $passport =$this->Passport->find()->contain('Specie.Collection')
                                             ...
                                             ->where(['Passport.status' => '1', 'Passport.resource_id' => 3,'Passport.id'=>$bankDna->passport_id])->first();
                ...
                try{
                    ...
                    if ($this->BankDna->save($bankDna)) {
                        ...
                        if($extractionDna!=null)
                            return $this->redirect(['controller' => 'ExtractionDnaMicro', 'action' => 'edit',$bankDna->id]);
                    ...
                    $this->Flash->error(__('Hubo inconvenientes al actualizar el Banco ADN. Por favor, Otra vez intente. '.$e->getMessage()));
                    return $this->redirect(['action' => 'index']);
                   }
            }
    ...
    public function delete($id = null)
    {
        ...
        if($this->permiso['delete'] /*&& $validar*/){
            ...
            if($bankDna_count>0){
                ...
                $bankDna = $this->BankDna->find()
                                             ->where(['BankDna.status !=' => '0','BankDna.id'=>$id,'BankDna.type_resource '=>3
                                                ])->first()  ;
