...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($child, ['controller' => 'InputField', 'action' => 'edit','id'=>$id,'child'=>$child]);
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-primary" id="btnInputField">GRABAR</button>
