...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($bankInvitro->id, ['controller' => 'BankInvitro', 'action' => 'edit','id'=>$bankInvitro->id]);
            ...
            <div class="box box-success">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <?php echo $this->Form->control('rooting',
                                                            ...
                                                            'label' => __('Enraizamiento' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Capacidad del material vegetal de formar raiz en el medio de cultivo in vitro"></i>'),
                                                            'escape' => false,
                                                            'class' => 'form-control',
                                                            'empty' => '-- SELECCIONE --' ]);
                                                    ?>
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                         ...
                         <button type="submit" class="btn btn-primary" id="btnBankInvitro">GRABAR</button>
