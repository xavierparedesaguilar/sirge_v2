...
<section class="content-header">
    <h1> <?php echo $modulo ?></h1>
       ...
       <?php
        ...
        $this->Html->addCrumb('Reporte Fitogenético', ['controller' => 'ReporteForestal', 'action' => 'index']);
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                     <h4 class="box-title" ><strong><?= __('Recursos Fitogenéticos') ?></strong></h4>


                </div>
                    <?php echo $this->Form->create(NULL, [
                        //'novalidate',
                        'url' => ['controller' => 'ReporteForestal', 'action' => 'index'],
                        'class' => 'row p-10',
                        'autocomplete' => "off",
                        'id'=>'idForm_Reporte'
                    ]); ?>
                    ...
                    <h4 class="box-title" style="text-decoration: underline;font-weight: bold"><?php echo $titulo ?></h4>
                        ...
                        <?php if(count($lista_rows)>0) { ?>
                            ...
                            <?php echo $this->Html->link('<i class="fa fa-fw fa-file-excel-o" ></i> Exportar',
                                                    ['controller' => 'ReporteForestal', 'action' => 'export','id'=>$this->request->data['tip_repor']],
