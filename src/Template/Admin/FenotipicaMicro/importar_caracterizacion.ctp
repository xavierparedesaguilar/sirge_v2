    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($descriptor, [
                    'url'     => ['controller' => 'FenotipicaMicro', 'action' => 'exportarCaracterizacion'],
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($descriptor, [
                    'url'     => ['controller' => 'FenotipicaMicro', 'action' => 'importarCaracterizacion'],
    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <div class="box-footer">
                    <?php echo $this->Form->create($descriptor, [
                        'url' => ['controller' => 'FenotipicaMicro', 'action' => 'cargarCaracterizacion'],
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <?php echo $this->Html->link('CANCELAR',['controller'=>'FenotipicaMicro','action'=>'index'],['class'=>'btn btn-default']) ?>
                    </div>
                    <?= $this->Form->end() ?>
                </div>
