            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <?php echo $this->Html->link('<i class="fa fa-cloud-download"></i>', ['controller' => 'FenotipicaMicro', 'action' => 'exportardescriptores'], ['class' => 'btn btn-warning', 'data-toggle' => "tooltip", 'title' => "Descargar plantilla de estados de descriptores.", 'escape' => false] ); ?>
                    </div>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-12 col-md-12 col-lg-12">
                            <div class="box box-success">
                                <?php echo $this->Form->create($descriptor, [
                                    'url'         => ['controller' => 'FenotipicaMicro', 'action' => 'importar'],
                                    'autocomplete'=> "off",
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12">
                            <div class="box box-success">
                                ...
                                <div class="box-footer">
                                    <div class="col-sm-12 text-center">
                                        <?php echo $this->Form->create($descriptor, [
                                              'url' => ['controller' => 'FenotipicaMicro', 'action' => 'uploadfile'],
                                              'autocomplete' => "off",
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <?php echo $this->Html->link('<i class="fa fa-cloud-download"></i>', ['controller' => 'FenotipicaMicro', 'action' => 'exportarestados'], ['class' => 'btn btn-warning', 'data-toggle' => "tooltip", 'title' => "Descargar plantilla de estados de descriptores.", 'escape' => false] ); ?>
                    </div>
                </div>
                <div class="box-body">
                    <div class="row">
