...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($descriptor->name, ['controller' => 'DescriptorMicro', 'action' => 'view', 'idx' => $especie->id, 'id' => $descriptor->id ]);
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-arrow-left"></i>',
                                ['controller' => 'DescriptorMicro', 'action' => 'index', 'id' => $descriptor->specie->id], ['class' => 'btn btn-default', 'data-toggle' => "tooltip", 'title' => "Retornar al anterior.", 'escape' => false])
                        ?>
                    </div>
                    <br>
                </div>
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        <?php echo $this->Html->link('EDITAR', ['controller' => 'DescriptorMicro', 'action' => 'edit', 'id' => $descriptor->id, 'idx' => $descriptor->specie->id], ['class' => 'btn btn-primary'] ); ?>
                        <?php echo $this->Html->link('ELIMINAR', "#",['class' => 'btn btn-danger delete-btn', 'escape' => false, "data-id"=>$descriptor->id])?>
                        <?php echo $this->Html->link('REGRESAR', ['controller' => 'DescriptorMicro', 'action' => 'index', 'id' => $descriptor->specie->id], ['class' => 'btn btn-default']) ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php $url = $this->Html->link('Confirmar', ['controller' => 'DescriptorMicro', 'action' => 'delete', 'idx' => $descriptor->specie->id, 'id' => $descriptor->id], ['class' => 'btn btn-success btn-flat btnEliminar' ]) ?>
