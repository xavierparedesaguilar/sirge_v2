...
<section class="content-header">
    <h1>Módulo <?php echo $titulo ?> - Detalle</h1>
       ...
       <?php
        ...
        $this->Html->addCrumb($child, ['controller' => 'OutputDna', 'action' => 'view','id'=>$id,'child'=>$child]);
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-edit" ></i>',
                                    ['controller' => 'OutputDna', 'action' => 'edit','id'=> $outputDna->bank_dna_id,'child'=> $outputDna->id],
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-arrow-left" ></i>',
                                ['controller' => 'OutputDna', 'action' => 'index','id'=> $outputDna->bank_dna_id],
                ...
                <div class="box-footer">
                    ...
                    <?php if($permiso['edit'] && $validar){ ?>
                    <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/fitogenetico/gestion-inventario/banco-adn/'.$outputDna->bank_dna_id.'/salida/editar/'.$outputDna->id, true) ?>"
                    ...
                    ?>
                    <?php } ?>
                    <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/fitogenetico/gestion-inventario/banco-adn/'.$outputDna->bank_dna_id.'/salida', true) ?>"
...
<script>
    ...
    $(".delete-btn").click(function(){
        $("#ajax_button").html('<?php echo $this->Html->link('Confirmar',
                                    ['controller' => 'OutputDna', 'action' => 'delete','id'=> $outputDna->bank_dna_id,'child'=> $outputDna->id],
