...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($descriptor->name, ['controller' => 'DescriptorZoo', 'action' => 'view', 'idx' => $especie->id, 'id' => $descriptor->id ]);
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <?php if ($permiso['edit']) { ?>
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-pencil-square-o"></i>',
                                ['controller' => 'DescriptorZoo', 'action' => 'edit', 'idx' => $descriptor->specie->id, 'id' => $descriptor->id],
                    ...
                    <?php } ?>
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-arrow-left"></i>',
                                ['controller' => 'DescriptorZoo', 'action' => 'index', 'id' => $descriptor->specie->id], ['class' => 'btn btn-default', 'data-toggle' => "tooltip", 'title' => "Retornar al anterior.", 'escape' => false])
                        ?>
                    </div>
                    <br>
                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $descriptor->recursodes;  ?></td>
                                            </tr>
                ...
                <div class="box-footer">
                    ...
                    <?php if ($permiso['edit']) { ?>
                        <?php echo $this->Html->link('EDITAR', ['controller' => 'DescriptorZoo', 'action' => 'edit', 'id' => $descriptor->id, 'idx' => $descriptor->specie->id], ['class' => 'btn btn-primary'] ); ?>
                    <?php } ?>
                    ...
                    <?php } ?>
                        ...
                        <?php echo $this->Html->link('REGRESAR', ['controller' => 'DescriptorZoo', 'action' => 'index', 'id' => $descriptor->specie->id], ['class' => 'btn btn-default']) ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php $url = $this->Html->link('Confirmar', ['controller' => 'DescriptorZoo', 'action' => 'delete', 'idx' => $descriptor->specie->id, 'id' => $descriptor->id], ['class' => 'btn btn-success btn-flat' ]) ?>
