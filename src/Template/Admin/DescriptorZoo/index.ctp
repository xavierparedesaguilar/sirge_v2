                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <?php if($permiso['add']){ ?>
                            ...
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i>', $this->Url->build('/' . $this->request->url . '/crear', true),
                                                        ['class' => 'btn btn-success','data-toggle' => "tooltip",
                                                         'title' => "Agregar nuevo descriptor.", 'escape' => false] );
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-plus-circle"></i>',
                                                ['controller' => 'DescriptorStateZoo', 'action' => 'index', 'idy' => $descriptor->specie->id, 'idx' => $descriptor->id],
                                    ...
                                    <?php if ($permiso['view']) { ?>
                                        ...
                                        <?php echo $this->Html->link('<i class="fa  fa-search-plus"></i>',
                                                ['controller' => 'DescriptorZoo', 'action' => 'view', 'idx' => $descriptor->specie->id, 'id' => $descriptor->id],
