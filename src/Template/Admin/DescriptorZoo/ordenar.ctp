...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb( ucfirst(mb_strtolower($mod_specie->collection->colname,'UTF-8')).' - '.ucfirst(mb_strtolower($mod_specie->species,'UTF-8')),
                    ['controller' => 'DescriptorZoo', 'action' => 'caracterizacion', 'idx' => $mod_specie->id, 'idy' => $mod_specie->collection->id ]);
                ...
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                         ...
                         <?php echo $this->Html->link('<i class="fa fa-arrow-left" ></i>',
                                ['controller' => 'DescriptorZoo', 'action' => 'caracterizacion', 'idx'=>$idx , 'idy' => $idy],
                                ['class' => 'btn  btn-default', 'data-toggle'=> "tooltip",  'title'=> "Regresar", 'escape'=>false])
                        ?>
                    </div>
                </div>
                <?= $this->Form->create(NULL, ['url' => ['controller' => 'DescriptorZoo', 'action' => 'ordenar', 'idx'=> $idx, 'idy' => $idy] ]) ?>
                <div class="box-body">
                        <div class="row">
