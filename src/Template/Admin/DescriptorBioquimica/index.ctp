                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-plus-circle"></i>',
                                                ['controller' => 'DescriptorStateBioquimica', 'action' => 'index', 'idy' => $descriptor->specie->id, 'idx' => $descriptor->id],
                                        ...
                                        <?php echo $this->Html->link('<i class="fa  fa-search-plus"></i>',
                                                ['controller' => 'DescriptorBioquimica', 'action' => 'view', 'idx' => $descriptor->specie->id, 'id' => $descriptor->id],
