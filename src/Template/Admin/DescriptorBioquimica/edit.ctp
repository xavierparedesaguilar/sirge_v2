...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($descriptor->name, ['controller' => 'DescriptorBioquimica', 'action' => 'edit', 'idx' => $especie->id, 'id' => $descriptor->id ]);
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-12">
                        <div class="row">
                            <div class="col-lg-6 col-sm-12 col-xs-12">
                                <?php echo $this->Form->control('resource', ['type' => 'hidden', 'value' => 4]) ?>
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        ...
                        <?php echo $this->Html->link('CANCELAR',
                                ['controller' => 'DescriptorBioquimica', 'action' => 'index', 'id' => $especie->id],
