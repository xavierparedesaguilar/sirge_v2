                    ...
                    <div class="pull-right box-tools">
						...
						<?php if(!empty($resultado)){ ?>
	                        ...
	                        <?php echo $this->Html->link('<i class="fa fa-sort-amount-asc" ></i>',
	                                    ['controller' => 'DescriptorBioquimica', 'action' => 'ordenar','idx'=>$idx,'idy'=>$idy],
						...
						<?php if($permiso['export']) { ?>
                             ...
                             <button type="button" data-toggle="tooltip"  title="Exportar" id="export" class="btn btn-info waves-effect m-r-5" >
