...
<section class="content-header">
    <h1> <?php echo $modulo ?></h1>
       ...
       <?php
        ...
        $this->Html->addCrumb('Reporte Zoogenético', ['controller' => 'ReporteZoo', 'action' => 'index']);
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                     <h4 class="box-title" ><strong><?= __('Recursos Zoogenéticos') ?></strong></h4>


                </div>
                    <?php echo $this->Form->create(NULL, [
                        //'novalidate',
                        'url' => ['controller' => 'ReporteZoo', 'action' => 'index'],
                        'class' => 'row p-10',
                        'autocomplete' => "off",
                        'id'=>'idForm_Reporte'
                    ]); ?>
                ...
                <div class="col-lg-5 col-sm-12 col-xs-12 col-lg-offset-9 ">
                 ...
                 <?php if(count($lista_rows)>0) { ?>
                    ...
                    <?php echo $this->Html->link('<i class="fa fa-fw fa-file-excel-o" ></i> Exportar',
                                            ['controller' => 'ReporteZoo', 'action' => 'export','id'=>$this->request->data['tip_repor']],
