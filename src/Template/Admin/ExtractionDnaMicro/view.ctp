        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-edit" ></i>',
                                    ['controller' => 'ExtractionDnaMicro', 'action' => 'edit', 'id'=>$extractionDna->bank_dna_id],
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo date('d-m-Y', strtotime($extractionDna->shorconstime  )) ?></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="col-xs-12 col-md-6 col-lg-6">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    <th scope="row"><?php echo __('Posición dentro del criobox') ?></th>
                                                    <td><?php echo $extractionDna->longcriopos ?></td>
                                                </tr>
                ...
                <div class="box-footer">
                    ...
                    <?php if($permiso['edit']) { ?>
                        <?php echo $this->Html->link('EDITAR', ['controller' => 'ExtractionDnaMicro', 'action' => 'edit','id'=>$extractionDna->bank_dna_id], ['class' => 'btn btn-primary'] ); ?>
