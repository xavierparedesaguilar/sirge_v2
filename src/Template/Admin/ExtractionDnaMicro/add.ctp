        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($extractionDna, [
                             // 'novalidate',
                            'url' => ['controller' => 'ExtractionDnaMicro', 'action' => 'add' ,'id'=>$id],
                            'autocomplete' => "off",
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 col-xs-12">
                                                            ...
                                                            <?php echo $this->Form->control('extmethod',
                                                                    ...
                                                                    'label' => __('Método de extracción' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Indica el método de extración de adn"></i>'),
                                                                    'escape' => false,
                                                                    'class' => 'form-control',
                                                                    'empty' => '-- SELECCIONE --' ]);
                                                            ?>
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 col-xs-12">
                                                     ...
                                                     <div class="col-lg-3 col-sm-12 col-xs-12">
                                                            ...
                                                            <?php echo $this->Form->control('leca260_280', [
                                                                        'label' => ['text' => 'lectura a 260/280' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Primer rango espectrofotometrico para  la concentración y pureza de adn  "></i>'],
                                                                        'escape' => false,
                                                                        'class' => 'form-control',
                                                            ]); ?>
                                                     ...
                                                     <div class="col-lg-3 col-sm-12 col-xs-12">
                                                            ...
                                                            <?php echo $this->Form->control('leca260_230', [
                                                                        'label' => ['text' => 'Lectura a 260/230' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Segundo rango espectrofotometrico para  la concentración y pureza de adn  "></i>'],
                                                                        'escape' => false,
                                                                        'class' => 'form-control',
                                                            ]); ?>
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 col-xs-12">
                                                     ...
                                                     <div class="col-lg-3 col-sm-12 col-xs-12">
                                                            ...
                                                            <?php echo $this->Form->control('longstornumb', [
                                                                        'label' => ['text' => 'Código almacenamiento' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Código del equipo de alamacenamiento"></i>'],
                                                                        'escape' => false,
                                                                        'class' => 'form-control',
                                                            ]); ?>
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-success" id="btnExtractionAdn">GRABAR</button>
                        ...
                        <?php /*echo $this->Html->link('CANCELAR', "#",
                                                                        ['class' => 'btn btn-danger  delete-btn', 'escape' => false, "data-id"=>$extractionDna->bank_dna_id, 'data-toggle' => "tooltip", 'title' => ""])*/
                        ?>
                        <?php echo $this->Html->link('CANCELAR',
                                                    ['controller' => 'bankDnaMicro', 'action' => 'index'],
                                                    ['class' => 'btn btn-danger  delete-btn', 'escape' => false, 'data-toggle' => "tooltip", 'title' => ""])
                        ?>
