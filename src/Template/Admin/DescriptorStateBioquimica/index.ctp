...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($descriptor->name, ['controller' => 'DescriptorStateBioquimica', 'action' => 'index', 'idx' => $descriptor->id, 'idy' => $especie->id ]);
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-plus"></i>',['controller' => 'DescriptorStateBioquimica', 'action' => 'add', 'idy' => $descriptor->specie_id, 'idx' => $descriptor->id], ['class' => 'btn btn-success','data-toggle' => "tooltip", 'title' => "Agregar nuevo estado de descriptor.", 'escape' => false] ); ?>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php if($permiso['edit']) { ?>
                                            ...
                                            <?php echo $this->Html->link('<i class="fa fa-pencil-square-o"></i>',
                                                    ['controller' => 'DescriptorStateBioquimica', 'action' => 'edit', 'idy' => $descriptorState->descriptor->specie_id, 'idx' => $descriptorState->descriptor->id, 'id' => $descriptorState->id],
