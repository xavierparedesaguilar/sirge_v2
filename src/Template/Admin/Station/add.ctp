...
<h1>Módulo Estación Experimental Agraria</h1>
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><i class="fa fa-file-o"></i> <?= __('NUEVO REGISTRO - ESTACIÓN EXPERIMENTAL AGRARIA') ?></h4>
                </div>
                <?php echo $this->Form->create($station, [
                    'url' => ['controller' => 'Station', 'action' => 'add'],
                    'autocomplete' => "off",
                    'id' => "form_station"
                ]); ?>
                 <div class="box-body">
