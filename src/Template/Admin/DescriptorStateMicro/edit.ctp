...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb('Estado '.$descriptorState->label, ['controller' => 'DescriptorStateMicro', 'action' => 'edit', 'idx' => $descriptor->id, 'idy' => $descriptor->specie_id, 'id' => $descriptorState->id ]);
            ...
            <div class="box box-success">
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-primary" id="btnDescriptorState">GABAR</button>
