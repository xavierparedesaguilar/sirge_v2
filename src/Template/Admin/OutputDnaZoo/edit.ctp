...
<section class="content-header">
    <h1>Módulo <?php echo $modulo ?> - Editar</h1>
       ...
       <?php
        ...
        $this->Html->addCrumb($child, ['controller' => 'OutputDnaZoo', 'action' => 'edit','id'=>$id,'child'=>$child]);
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-primary" id="btnOutputDna">GRABAR</button>
...
$this->Html->scriptBlock('
    $("#fecha-salida").datepicker({autoclose: true,todayHighlight: true, language: "es", format: "yyyy-mm-dd"});
', ['block' => true]);
