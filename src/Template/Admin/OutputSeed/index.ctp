                        ...
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            <thead class="headTablaListado">
                                <tr class="text-uppercase text-center th-head-inputs">
                                     ...
                                     <th style="min-width: 150px;">NUM. DE SEMILLAS</th>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($outputSeed as $outputSeed): ?>
                                 <tr>
                                    ...
                                    <td><?= empty($outputSeed->exitdate)? '' : date("d-m-Y", strtotime($outputSeed->exitdate))  ?></td>
                                    ...
                                    <?php if($permiso['edit'] /*&& $validar*/ ) { ?>
                                          ...
                                          <a href="<?php echo $this->Url->build('/'.$this->request->url.'/editar/'.$outputSeed->id, true) ?>" class="btn btn-primary btn-xs" data-toggle = "tooltip" title = "Editar información de la Salida de Material."><i class="fa fa-pencil-square-o"></i></a>
                                    ...
                                    <?php if($permiso['delete'] /*&& $validar*/ ) { ?>
                                          ...
                                          <?php echo $this->Html->link('<i class="fa fa-trash-o"></i>', "#",
                                                ['class' => 'btn btn-danger btn-xs delete-btn', 'escape' => false, "data-id"=>$outputSeed->id, 'data-toggle' => "tooltip", 'title' => "Eliminar la Entrada de Material."])
                                          ?>
