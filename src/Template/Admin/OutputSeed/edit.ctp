...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($child, ['controller' => 'OutputSeed', 'action' => 'edit','id'=>$id,'child'=>$child]);
                ...
                <div class="box-header with-border">
                 ...
                 <div class="box-body">
                    ...
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-primary" id="btnOutputSeed">GRABAR</button>
                        <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/fitogenetico/gestion-inventario/banco-semilla/'.$bankSeed->id.'/salida', true) ?>"
