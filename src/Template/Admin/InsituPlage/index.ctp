...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb('Plagas Patógenos');
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <?php if ($permiso['add']) { ?>
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-plus"></i>',['controller' => 'InsituPlage', 'action' => 'add', 'idx' => $insitu->id], ['class' => 'btn btn-success','data-toggle' => "tooltip", 'title' => "Agregar nueva Plaga / Patógeno.", 'escape' => false] ); ?>
                    <?php } ?>
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php $item = 1 ?>
                                <?php foreach ($insituPlage as $insituPlage): ?>
                                <tr>
                                    <td><?= $item ?></td>
                                    ...
                                    <?php if ($permiso['view']) { ?>
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-search-plus"></i>',
                                                ['controller' => 'InsituPlage', 'action' => 'view', 'id' => $insituPlage->id, 'idx' => $insituPlage->insitu_id],
                                                ['class' => 'btn btn-info btn-xs', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Ver información de la Plaga / Patógeno."])
                                        ?>
                                    <?php } ?>
                                    ...
                                    <?php if ($permiso['edit']) { ?>
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-pencil-square-o"></i>',
                                                ['controller' => 'InsituPlage', 'action' => 'edit', 'id' => $insituPlage->id, 'idx' => $insituPlage->insitu_id],
                                                ['class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Editar la Plaga / Patógeno."])
                                        ?>
                                    <?php } ?>
                                    ...
                                    <?php if ($permiso['delete']) { ?>
                                        <?php
                                            echo $this->Html->link('<i class="fa fa-trash-o"></i>', "#",
                                                ['class' => 'btn btn-danger btn-xs delete-btn', 'escape' => false, "data-id"=>$insituPlage->id, 'data-toggle' => "tooltip", 'title' => "Eliminar la Plaga / Patógeno."])
                                        ?>
                                    <?php } ?>
                                    </td>
                                </tr>
