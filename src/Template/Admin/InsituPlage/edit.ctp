...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($insituPlage->id, ['controller' => 'InsituPlage', 'action' => 'edit', 'idx' => $insitu->id, 'id' => $insituPlage->id]);
            ...
            <div class="box box-success">
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        <?php echo $this->Form->button('GRABAR',['class'=>'btn btn-primary', 'id'=>'btnInsituPlage']) ?>
