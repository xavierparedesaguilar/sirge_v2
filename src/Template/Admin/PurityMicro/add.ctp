            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <?php echo $this->Form->create($purityMicro, [
                        'url' => ['controller' => 'PurityMicro', 'action' => 'add' ,'id'=>$id],
                        'class' => 'row p-10',
                        'autocomplete' => "off",
                        'id' => "form_purezaMicro",
                         // 'novalidate'
                ...
                <div class="box-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                                ...
                                                <?php echo $this->Form->control('isolamed_1',
                                                        ...
                                                        'label' => 'Medio de Aislamiento 1' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Medio de cultivo no diferncial para el microorganimos"></i>',
                                                        'escape' => false,
                    ...
                    <div class="col-sm-12 text-center">
                            <button type="submit" class="btn btn-success" id="btnPurezaMicro">GRABAR</button>
...
$this->Html->scriptBlock('
    $("#fecha_prueba").datepicker({autoclose: true,todayHighlight: true, language: "es", format: "dd-mm-yyyy"});
', ['block' => true]);
