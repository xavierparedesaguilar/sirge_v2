                ...
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-plus" ></i>',
                                    ['controller' => 'PurityMicro', 'action' => 'add','id'=>$id],
                                    ['class' => 'btn btn-success', 'data-toggle'=> "tooltip",  'title'=> "Nueva Prueba de Pureza", 'escape'=>false] )
                        ?>
                        <?php } ?>
                              ...
                              <table id="tablaListado" class="table table-striped table-bordered table-hover">
                                    <thead class="headTablaListado">
                                        <tr class="text-uppercase text-center th-head-inputs">
                                             ...
                                             <th style="min-width: 150px;">MEDIO DE AISLAMIENTO 1</th>
                                             <th style="min-width: 170px;">DURACIÓN DEL MICROORGANISMO MEDIO 1</th>
                                             <th style="min-width: 165px;">TEMPERATURA DEL MEDIO 1</th>
                                             <th style="min-width: 160px;">MEDIO DE AISLAMIENTO 2</th>
                                             <th style="min-width: 170px;">DURACIÓN DEL MICROORGANISMO MEDIO 2</th>
                                             <th style="min-width: 170px;">TEMPERATURA DEL MEDIO 2</th>
                                             <th style="min-width: 170px;">TINCIÓN GRAM</th>
                                             <th style="min-width: 170px;">TINCIÓN CON AZUL DE LACTOFENOL</th>
                                             <th style="min-width: 170px;">FECHA DE PRUEBA DE PUREZA</th>
                                    ...
                                    <tbody>
                                        <?php $item = 1; ?>
                                        <?php foreach ($purityMicro as $purityMicro): ?>
                                         <tr>
                                            <td><?php echo $this->Number->format($item) ?></td>
                                            <td><?php echo $purityMicro->medio==NULL?'': $purityMicro->medio->name; ?></td>
                                            <td><?php echo ($purityMicro->reactime_1) ?></td>
                                            <td><?php echo ($purityMicro->reactemp_1) ?></td>
                                            ...
                                            <td><?php echo ($purityMicro->gramstain) ?></td>
                                            <td><?php echo $purityMicro->tincionazul==NULL?'': $purityMicro->tincionazul->name; ?></td>
                                            <td><?php echo  $purityMicro->datepurz==null || $purityMicro->datepurz==''?'':date("d-m-Y", strtotime($purityMicro->datepurz))?></td>


                                            <td>
                                              <?php if($permiso['view']) { ?>

                                                  <a href="<?php echo $this->Url->build('/'.$this->request->url.'/ver/'.$purityMicro->id, true) ?>" class="btn btn-info btn-xs" data-toggle = "tooltip" title = "Ver información de la Prueba de Pureza."><i class="fa  fa-search-plus"></i></a>
                                                  <?php } ?>
                                                  ...
                                                  <a href="<?php echo $this->Url->build('/'.$this->request->url.'/editar/'.$purityMicro->id, true) ?>" class="btn btn-primary btn-xs" data-toggle = "tooltip" title = "Editar información de la Prueba de Pureza."><i class="fa fa-pencil-square-o"></i></a>
                                                  <?php } ?>

                                                    <?php if($permiso['delete'] /*&& $validar*/ ) { ?>
                                                  <?php echo $this->Html->link('<i class="fa fa-trash-o"></i>', "#",
                                                                            ['class' => 'btn btn-danger btn-xs delete-btn', 'escape' => false, "data-id"=>$purityMicro->id, 'data-toggle' => "tooltip", 'title' => "Eliminar la Entrada de Material."])
                                                   ?>
                                                   <?php } ?>
