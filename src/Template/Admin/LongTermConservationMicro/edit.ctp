...
<section class="content-header">
    <h1>Módulo <?php echo $modulo ?> - Editar</h1>
       ...
       <?php
        ...
        $this->Html->addCrumb($child, ['controller' => 'LongTermConservationMicro', 'action' => 'edit','id'=>$id,'child'=>$child]);
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <?php echo $this->Form->control('longtermtemp', [
                                                            'label' => ['text' => 'Temperatura' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Define la temperatura que se debe conservar el microorganismo"></i>'],
                                                            'escape' => false,
                                                            'class' => 'form-control',
                                                ]); ?>
                                            </div>
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                                ...
                                                <?php echo $this->Form->control('criopro',
                                                        ...
                                                        'label' => 'Crioprotector' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Tipo de solucionez usadas para crioperservación "></i>',
                                                        'escape' => false,
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <?php echo $this->Form->control('fecha_renovacion', [
                                                            ...
                                                            'escape' => false,
                                                            'class' => 'form-control',
                                                            'value'=>$longTermConservationMicro->renewal_date,
                                                            'id'=>'fecha_renovacion',
                                                            // 'readonly' => true
                                                ]); ?>
                                            </div>
                    ...
                    <div class="col-sm-12 text-center">
                            <button type="submit" class="btn btn-primary" id="btnConservationMicro">GRABAR</button>
