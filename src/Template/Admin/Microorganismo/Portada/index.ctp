...
<?php
    ...
    $icons = array( '31' => array('img' => $this->Html->image('icons/pasaporte.png', ['class' => "img-rounded", 'height' => '75'])),
                    '32' => array('img' => $this->Html->image('icons/caracterizacion_micro.png', ['class' => "img-rounded", 'height' => '75'])),
                    '36' => array('img' => $this->Html->image('icons/inventario.png', ['class' => "img-rounded", 'height' => '75'])),
                    '40' => array('img' => $this->Html->image('icons/reportes.png', ['class' => "img-rounded", 'height' => '75'])),
                    '41' => array('img' => $this->Html->image('icons/mapas.png', ['class' => "img-rounded", 'height' => '75'])),
                );
?>
