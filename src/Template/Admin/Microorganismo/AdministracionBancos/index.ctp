...
<?php
    ...
    $icons = array( '37' => array('img' => $this->Html->image('icons/banco_adn.png', ['class' => "img-rounded", 'height' => '75'])),
                    '38' => array('img' => $this->Html->image('icons/banco_micro.png', ['class' => "img-rounded", 'height' => '75'])),
                );
?>
