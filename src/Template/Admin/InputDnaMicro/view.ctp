...
<section class="content-header">
    <h1>Módulo <?php echo $titulo ?> - Detalle</h1>
        ...
        $this->Html->addCrumb($id, ['controller' => 'InputDnaMicro', 'action' => 'index','id'=>$id]);
        $this->Html->addCrumb('Entrada');
        $this->Html->addCrumb($inputDna->id, ['controller' => 'InputDnaMicro', 'action' => 'view','id'=>$id,'child'=>$inputDna->id]);
                ...
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-edit" ></i>',
                                    ['controller' => 'InputDnaMicro', 'action' => 'edit','id'=> $inputDna->bank_dna_id,'child'=> $inputDna->id],
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-arrow-left" ></i>',
                                    ['controller' => 'InputDnaMicro', 'action' => 'index','id'=> $inputDna->bank_dna_id],
                ...
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        <div class="col-sm-12 text-center">
                                ...
                                <?php if($permiso['edit'] && $validar){ ?>
                               <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/microorganismo/gestion-inventario/banco-adn/'.$inputDna->bank_dna_id.'/entrada/editar/'.$inputDna->id, true) ?>"
                                ...
                                <?php if($permiso['delete'] && $validar){ ?>
                                        <?php echo $this->Html->link('ELIMINAR', "#",
                                         ...
                                         ?>
                                <?php } ?>
                                <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/microorganismo/gestion-inventario/banco-adn/'.$inputDna->bank_dna_id.'/entrada', true) ?>"
...
<script>
    ...
    $(".delete-btn").click(function(){
        $("#ajax_button").html('<?php echo $this->Html->link('Confirmar',
                                    ['controller' => 'InputDnaMicro', 'action' => 'delete','id'=> $inputDna->bank_dna_id,'child'=> $inputDna->id],
