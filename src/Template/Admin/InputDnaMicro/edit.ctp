...
<section class="content-header">
    <h1>Módulo <?php echo $modulo ?> - Editar</h1>
       <?php
        ...
        $this->Html->addCrumb($inputDna->id, ['controller' => 'InputDnaMicro', 'action' => 'edit','id'=>$id,'child'=>$inputDna->id]);
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                                ...
                                                <?php echo $this->Form->control('tipdep',
                                                        ...
                                                        'label' => 'Tipo Depósito' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Indica la categoria de deposito del adn"></i>',
                                                        'escape' => false,
                    ...
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-primary" id="btnInputDnaZoo">GRABAR</button>
