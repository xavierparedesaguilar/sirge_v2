...
<div class="content">
    <div class="row">
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($descriptor, [
                    'url'     => ['controller' => 'FenotipicaZoo', 'action' => 'exportarCaracterizacion'],
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title"><strong>CARGA DE REGISTROS</strong></h3>
                </div>
                <?php echo $this->Form->create($descriptor, [
                    'url'     => ['controller' => 'FenotipicaZoo', 'action' => 'importarCaracterizacion'],
    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <div class="box-footer">
                    <?php echo $this->Form->create($descriptor, [
                        'url' => ['controller' => 'FenotipicaZoo', 'action' => 'cargarCaracterizacion'],
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <?php echo $this->Html->link('CANCELAR',['controller'=>'FenotipicaZoo','action'=>'index'],['class'=>'btn btn-default']) ?>
                    </div>
                    <?= $this->Form->end() ?>
                </div>
