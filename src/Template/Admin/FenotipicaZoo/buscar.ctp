			...
			<div class="box box-success">
				<div class="box-header with-border">
                    ...
                    <?php if($permiso['import']) { ?>
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-cloud-upload"></i>', ['controller' => 'FenotipicaZoo', 'action' => 'importarCaracterizacion'], ['class' => 'btn btn-warning', 'data-toggle' => "tooltip", 'title' => "Importar Caracterización.", 'escape' => false]) ?>

                    <?php } ?>

                     <?php if($permiso['import']) { ?>

			    		<?php echo $this->Html->link('<i class="fa fa-cloud-upload"></i>', ['controller' => 'FenotipicaZoo', 'action' => 'importar'], ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Importar Descriptores y Estados.", 'escape' => false] ); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php echo $this->Html->link('Descriptores',
                                                ['controller' => 'DescriptorZoo', 'action' => 'index', 'id' => $specie->id],
                                        ...
                                        <?php echo $this->Html->link('Caracterización',
                                                ['controller' => 'DescriptorZoo', 'action' => 'caracterizacion', 'idx'=> $specie->id, 'idy' => $specie->collection->id ],
