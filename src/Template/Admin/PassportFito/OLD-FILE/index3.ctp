        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title"><strong><i class="fa fa-database"></i> BASE DE DATOS PASAPORTE </strong></h3>
                        ...
                        <table id="tablaListado" class="table table-striped table-bordered  table-hover row-border order-column" cellspacing="0" width="100%">
                            <thead class="headTablaListado">
                                <tr class="text-uppercase text-center th-head-inputs">
                                     <th rowspan="2">#</th>
                                     <th rowspan="2">COD. ACCESIÓN</th>
                                     <th rowspan="2">NOMBRE ACCESIÓN</th>
                                     <th rowspan="2" style="min-width: 120px;">CÓDIGO DE COLECTA</th>
                                     <th rowspan="2">OTRO COD. ACCESIÓN</th>
                                     <th rowspan="2" style="min-width: 120px;">COLECCIÓN</th>
                                     <th rowspan="2">NOMBRE CIENTÍFICO</th>
                                     <th rowspan="2">NOMBRE COMÚN</th>
                                     <th rowspan="2">FECHA INTR GENBANK</th>
                                     <th rowspan="2">SUBTIPO RECURSO</th>
                                     <th rowspan="2">TIPO CONSERVACIÓN</th>
                                     <th rowspan="2">EST. EXPERIMENTAL.</th>
                                     <th rowspan="2">COD. FAO</th>
                                     <th rowspan="2">DISPONIBILIDAD</th>
                                     <th colspan="3">LUGARES DE CONSERVACIÓN</th>
                                     <th rowspan="2" style="border-color:#fff">OPCIONES</th>
