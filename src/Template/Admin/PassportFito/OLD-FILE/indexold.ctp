            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php if($permiso['export']) { ?>
                             ...
                             <button type="submit" data-toggle="tooltip"  title="Exportar Listado de Pasaporte" id="export" class="btn btn-info waves-effect m-r-5" >
				...
				<div class="box-body" style="position: relative;"> 
					<div id= "overlayTable">
                     ...
                     <div class="col-sm-12">
                        <table id="tablaListado" class="table table-striped table-bordered table-hovertable" >
                            <thead class="headTablaListado">
                                <tr class="text-uppercase text-center th-head-inputs">
                                     ...
                                     <th style="min-width: 170px;">CÓDIGO DE COLECTA</th>
