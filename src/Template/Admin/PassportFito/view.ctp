                                        ...
                                        <div class="col-xs-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="table-responsive">  
                                             <table class="table table-striped table-bordered table-hover">
                                                 <tr>
                                                    <td scope="row" width="70%"><strong><?= __('Código del Instituto (COD. FAO)') ?></strong></td>
                                            ...
                                            <div class="table-responsive">  
                                             <table class="table table-striped table-bordered table-hover">
                                               ...
                                               <tr>
                                                 ...
                                                 <td><em><?php echo $passportFito->passport->especiefito==NULL? '' : $passportFito->passport->especiefito->genus.' '.$passportFito->passport->especiefito->species; ?></em> <?php echo $passportFito->passport->especiefito==NULL? '' : $passportFito->passport->especiefito->autor;?></td>
                                                </tr>
                                                <tr>
