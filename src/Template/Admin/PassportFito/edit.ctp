        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="panel panel-default">      
                 <div class="panel-heading ">
                    <h4><i class="fa fa-pencil-square-o"></i> <?= __('ACTUALIZACIÓN DE REGISTRO DATO PASAPORTE:') ?><strong> <?= $passport->accenumb?></strong></h4>
                </div>
                               ...
                               <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12 col-xs-12">
                                      <?php echo $this->Form->control('passport.station_current_id', [
                                                        ...
                                                        'label'  => __('EEA de Conservación '. $this->Functions->validarObligatorio('station_current_id',$lista) . ' <i class="fa fa-info-circle" data-toggle="tooltip" title=EEA donde se cnserva el Material Genético"></i>'),
                                                        'escape' => false,
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-lg-6 col-sm-12 col-xs-12">
                                    <?php echo $this->Form->control('fecha_aquisicion', [
                                                            'label'   => ['text' => 'Fecha Introducción al GENBANK '. $this->Functions->validarObligatorio('acqdate',$lista) . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Fecha en la que se incorporo la accesión a la colección"></i>'],
                                                            'escape' => false,
                                                            'class'   => 'form-control',
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="row">                                     
                                   ...
                                   <?php echo $this->Form->control('passportFito.collmissind', [
                                                                    'label' => ['text' => 'Misión de Colecta '.  ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Nombre de Proyecto que se realizo la colecta"></i>'],
                                                                    'escape' => false,
                                                                    'class' => 'form-control',
