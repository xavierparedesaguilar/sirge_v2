        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title"><strong>Listados de <?php echo $titulo_lista ?></strong></h3>
                    <div class="pull-right box-tools">

                        <?php if($permiso['add']){ ?>
                        <?php echo $this->Html->link('<i class="fa fa-plus" ></i>',
                                    ['controller' => 'BankDna', 'action' => 'add'],
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php echo $this->Html->link('<i class="fa fa-sign-in"></i>',
                                                                        ['controller' => 'inputDna', 'action' => 'index', $bankDna->id],
                                                                        ['class' => 'btn btn-success btn-xs', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Entrada al Banco ADN."])
                                                                ?>
                                    <?php echo $this->Html->link('<i class="fa fa-sign-out"></i>',
                                                                        ['controller' => 'outputDna', 'action' => 'index', $bankDna->id],
                                    ...
                                    <?php echo $this->Html->link('<i class="fa fa-search-plus"></i>',
                                                                        ['controller' => 'bankDna', 'action' => 'view', $bankDna->id],
                                    ...
                                    <?php if($bankDna->Extraccion==NULL){ ?>
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-plus"></i>',
                                                                            ['controller' => 'extractionDna', 'action' => 'add','id'=> $bankDna->id],
                                    ...
                                    <?php if($bankDna->Extraccion!=NULL){ ?>
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-search-plus"></i>',
                                                                            ['controller' => 'extractionDna', 'action' => 'view','id'=> $bankDna->id,'child'=>$bankDna->Extraccion->id],
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-pencil-square-o"></i>',
                                                                        ['controller' => 'extractionDna', 'action' => 'edit','id'=> $bankDna->id,'child'=>$bankDna->Extraccion->id],
