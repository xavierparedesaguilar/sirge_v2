                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php if($permiso['add']) { ?>
                            ...
                            <?php echo $this->Html->link('<i class="fa fa-plus" ></i>',
                                                        ['controller'=>'CaractGenotypicZoo',
                                                         'action'=>'add'],['class'=>'btn btn-success',
                                                         'data-toggle'=>"tooltip" , 'title'=>"Nueva Caracterización Genotípica",
                                                        'escape' => false])
                            ?>
                        <?php } ?>
                        ...
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            <thead class="headTablaListado">
                                <tr class="text-uppercase text-center th-head-inputs">
                                    ...
                                    <th style="min-width: 130px">Nº de Iniciadores</th>
                                    <th style="min-width: 130px">Nº de Ciclos</th>
                                ...
                                <tr>
                                    ...
                                    <?php if($permiso['view']) { ?>
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-search-plus"></i>',
                                                ['controller' => 'CaractGenotypicZoo', 'action' => 'view', $caractGenotypic->id],
                                    ...
                                    <?php if($permiso['edit']) { ?>
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-pencil-square-o"></i>',
                                                ['controller' => 'CaractGenotypicZoo', 'action' => 'edit', 'id' => $caractGenotypic->id],
