        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($caractGenotypic, [
                    'url'          => ['controller' => 'CaractGenotypicZoo', 'action' => 'add'],
                    'autocomplete' => "off",
                        ...
                        <div class="box box-success">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                    <button class="btn btn-success btn-xs add_field_button"><i class="fa fa-plus"></i> AGREGAR ADAPTOR</button>
                                </div>
                            </div>
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        ...
                        <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/zoogenetico/caracterizacion/Genotipica', true) ?>"
