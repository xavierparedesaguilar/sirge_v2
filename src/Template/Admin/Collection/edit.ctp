...
<section class="content-header">
    <h1>Módulo Colección - <?php echo $collection->colname ?></h1>
    ...
    <?php
        ...
        $this->Html->addCrumb($collection->colname, ['controller'=> 'Collection', 'action' => 'edit', 'id' => $collection->id]);
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
             <div class="panel panel-default">    
                ...
                <div class="panel-heading ">
                    <h4><i class="fa fa-pencil-square-o"></i> <?= __('ACTUALIZACIÓN DE DATOS:') ?> <strong><?php echo $collection->colname ?></strong> </h4>
                </div>
                <?php echo $this->Form->create($collection, [
                        'url' => ['controller' => 'Collection', 'action' => 'edit'],
                        'autocomplete' => "off",
                        'id' => "form_collection",
                ]); ?>
             <div class="box-body">
                        ...
                        <div class="row"> 
                           <div class="col-lg-6 col-sm-12 col-xs-12">
                              ...
                              <?php echo $this->Form->control('availability', [
                                        'type'   => 'select',
                                        'options'=> ['1' => 'SI', '2' => 'NO'],
                                        'label'  => __('Disponibilidad de la Colección'),
                                        'class'  => 'form-control',
                                ]); ?>
