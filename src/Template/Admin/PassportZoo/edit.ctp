...
<section class="content-header">
    <h1>Módulo <?php echo $modulo ?> Zoogenético - Editar</h1>
    ...
    <?php
        ...
        $this->Html->addCrumb($passport->accenumb, ['controller' => 'PassportZoo', 'action' => 'edit', 'id' => $passportZoo->id]);
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($passportZoo, [
                    'url' => ['controller' => 'PassportZoo', 'action' => 'edit'],
                    'autocomplete' => "off",
                    'id' => "form_passportzoo",
                            ...
                            <div class="tab-content">
                                <div id="tabla1" class="tab-pane in active">
                                        ...
                                        <!-- INICIO DATOS PRINCIPALES -->
                                            <div class="col-lg-3 col-sm-12 col-xs-12">
                                                    <?php echo $this->Form->control('passport.accenumb', [
                                                                'label' => ['text' => 'Código de Accesión (COD. PER)' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Código accesión: código de identificación  local de la accesión"></i>'],
                                                                'escape' => false,
                                                                'class' => 'form-control',
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-lg-3 col-sm-12 col-xs-12">
                                                <?php echo $this->Form->control('coleccion_zoo', [
                                                          'class'   => 'form-control select2',
                                                          'label'   => 'Colección '. $this->Functions->validarObligatorio('specie_id',$lista) . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Nombre de la colección que pertenece la accesión"></i>',
                                                          'escape'  => false,
                                                          'type'    => 'select',
                                                          'options' => $colecciones,
                                                          'id'      => 'coleccion',
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-lg-3 col-sm-12 col-xs-12">
                                                    <?php echo $this->Form->control('passportZoo.storage',
                                                            ...
                                                            'default' => $passportZoo->storage,
                                                            'label' => __('Tipo de Conservación '. $this->Functions->validarObligatorio('storage',$lista) . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Tipo de preservación del material"></i>'),
                                                            'escape' => false,
                                                            'class' => 'form-control',
                                                            'empty' => '-- SELECCIONE --' ]);
                                                    ?>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-lg-3 col-sm-12 col-xs-12">
                                                <?php echo $this->Form->control('passportZoo.availability',
                                                            ...
                                                            'default' => $passportZoo->availability,
                                                ...
                                                <!-- INICIO DATOS UBIGEO -->
                                                    <div class="col-lg-3 col-sm-12 col-xs-12">
                                                            <?php echo $this->Form->control('passport.country_id', [
                                                                    ...
                                                                    'label'  => __('País Origen '. $this->Functions->validarObligatorio('country_id',$lista) . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Nombre del país de origen del material genetico"></i>'),
                                                                    'escape' => false,
                                                                    'class'  => 'form-control',
                                                                    'empty'  => '-- SELECCIONE --',
                                                                    'id'     => 'country_id',
                                                ...
                                                <!-- INICIO DATOS GEOREFERENCIALES -->
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 col-xs-12">
                                                            <?php echo $this->Form->control('passportZoo.coorddatum',
                                                                    ['type' => 'select',
                                                                    'options' => $coordenadas,
                                                                    'default' => $passportZoo->coorddatum,
                                            ...
                                            <div class="row">
                                                    <div class="col-lg-3 col-sm-12 col-xs-12">
                                                            <?php echo $this->Form->control('passportZoo.georefmeth',
                                                                    ['type' => 'select',
                                                                    'options' => $georref,
                                                                    'default' => $passportZoo->georefmeth,
                                                ...
                                                <!-- INICIO FOTOGRAFIA DE LA ACCESION -->
                                                    <div class="col-lg-3 col-sm-12 col-xs-12 text-center">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                                                                <?php
                                                                    if($passportZoo->accimag1 != NULL || $passportZoo->accimag1 != ''){
                                                                        echo "<img src=".$this->Url->build('/', true).$passportZoo->accimag1.">";
                                                                    } else {
                                                                ?>
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 col-xs-12 text-center">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                                                                <?php
                                                                    if($passportZoo->accimag2 != NULL || $passportZoo->accimag2 != ''){
                                                                        echo "<img src=".$this->Url->build('/', true).$passportZoo->accimag2.">";
                                                                    } else {
                                                                ?>
                                                                    <img src="<?php echo $this->Url->build('/img/noimagen.jpg', true) ?>" class="img-responsive">
                                                                <?php
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 col-xs-12 text-center">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                                                                <?php
                                                                    if($passportZoo->accimag3 != NULL || $passportZoo->accimag3 != ''){
                                                                        echo "<img src=".$this->Url->build('/', true).$passportZoo->accimag3.">";
                                                                    } else {
                                                                ?>
                                                                    <img src="<?php echo $this->Url->build('/img/noimagen.jpg', true) ?>" class="img-responsive">
                                                                <?php
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 col-xs-12 text-center">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                                                                <?php
                                                                    if($passportZoo->accimag4 != NULL || $passportZoo->accimag4 != ''){
                                                                        echo "<img src=".$this->Url->build('/', true).$passportZoo->accimag4.">";
                                                                    } else {
                                                                ?>
                                                                    <img src="<?php echo $this->Url->build('/img/noimagen.jpg', true) ?>" class="img-responsive">
                                                                <?php
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control b-radio text-uppercase" name="passportZoo[collsrc]"
                                                                ...
                                                                <?php foreach ($fuentes as $fuente): ?>
                                                                    <option value="<?php echo $fuente->id ?>" <?php echo ($passportZoo->collsrc == $fuente->id) ? 'selected' : ''; ?> >
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 col-xs-12">
                                                            <?php echo $this->Form->control('passportZoo.collsrcdet',
                                                                    ...
                                                                    'default' => $passportZoo->collsrcdet,
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 col-xs-12">
                                                            <?php echo $this->Form->control('passportZoo.sampling', [
                                                                        ...
                                                                        'escape' => false,
                                                                        'class' => 'form-control',
                                                                        'value' => $passportZoo->sampling,
                                                            ]); ?>
                                                    </div>

                                                    <div class="col-lg-3 col-sm-12 col-xs-12">
                                                            <?php echo $this->Form->control('passportZoo.anuspart', [
                                                                        'label' => ['text' => 'Partes útiles del Animal '. $this->Functions->validarObligatorio('anuspart',$lista) . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Corresponde a las partes utiles del animal que son utilizadas por  los pobladores con algún fin especifico"></i>'],
                                                                        'escape' => false,
                                                                        'class' => 'form-control',
                                                                        'value' => $passportZoo->anuspart,
                                                            ]); ?>
                                                    </div>
                                        ...
                                        <!-- INICIO CONDICIONES CLIMATICAS -->
                                            ...
                                            <div class="col-lg-3 col-sm-12 col-xs-12">
                                                    <?php echo $this->Form->control('passportZoo.precipitation', [
                                                                ...
                                                                'escape' => false,
                                                                'class' => 'form-control',
                                                                'value' => $passportZoo->precipitation,
                                                    ]); ?>
                                            </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-sm-12 col-xs-12">
                                                            <?php echo $this->Form->control('passportZoo.duplinstname', [
                                                                        ...
                                                                        'escape' => false,
                                                                        'class' => 'form-control',
                                                                        'value' => $passportZoo->duplinstname,
                                                            ]); ?>
                                                    </div>
                                            ...
                                            <div class="row">
                                                    <div class="col-lg-4 col-sm-12 col-xs-12">
                                                            <?php echo $this->Form->control('passportZoo.bdna',
                                                                    ...
                                                                    'escape' => false,
                                                                    'class' => 'form-control',
                                                                    'disabled' => ($passportZoo->bancoAdn > 0) ? true : false,
                                                                    'empty' => '-- SELECCIONE --' ]);
                                                            ?>
                                                    </div>
                                            </div>
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-primary" id="btnPassportZoo">GRABAR</button>
