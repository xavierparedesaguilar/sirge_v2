...
<section class="content-header">
    <h1>Módulo <?php echo $modulo ?> Zoogenético - Carga de Datos</h1>
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($passportZoo, [
                    'url'         => ['controller' => 'PassportZoo', 'action' => 'import'],
                    'autocomplete'=> "off",
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        ...
                        <a href="<?php echo $this->Url->build('/admin/zoogenetico/datos-pasaporte/exportar', true) ?>"  class="btn btn-info" >
                            DESCARGAR FORMATO DE IMPORTACIÓN
                        </a>
                        <?php echo $this->Html->link('CANCELAR', ['controller' => 'PassportZoo', 'action' => 'index'], ['class' => 'btn btn-default']) ?>
                    </div>
                </div>
                <?= $this->Form->end() ?>
...
<?php if(isset($temp_passport_zoo)){ ?>
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                        ...
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    for ($i=0; $i < count($temp_passport_zoo); $i++) {

                                        $temp_map = $temp_passport_zoo[$i];
                                        $temp_map = $temp_map->toArray();

                                        if($temp_passport_zoo[$i]['motivo_error'] !== ''){
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        <?php echo $this->Form->create($passportZoo, [
                              'url' => ['controller' => 'PassportZoo', 'action' => 'uploadfile'],
                              'autocomplete' => "off",
