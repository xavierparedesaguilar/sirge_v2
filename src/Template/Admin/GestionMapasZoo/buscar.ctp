        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <?php echo $this->Form->create(NULL, [
                            'url' => ['controller' => 'GestionMapasZoo', 'action' => 'index'],
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        ...
                        <?php echo $this->Html->link('CANCELAR','/admin/zoogenetico', ['class' => 'btn btn-default']) ?>
                    </div>
                </div>
                <?= $this->Form->end() ?>
            </div>
    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="box box-success">
            ...
            <?php if(count($passport) > 0){ ?>
                <?php echo $this->Form->create(null, [
                      'url' => ['controller' => 'GestionMapasZoo', 'action' => 'ver'],
...
$(document).ready(function(){
    var oTable = $('#myTable').DataTable(
	{
        "language": {
            ...
            '</select> registros',
            "oPaginate": {
                "sFirst": "<button class='fa fa-angle-double-left'></button>",
                "sLast": "<button class='fa fa-angle-double-right'></button>",
                "sNext": "<button class='fa fa-angle-right'></button>",
                "sPrevious": "<button class='fa fa-angle-left'></button>"
            },
