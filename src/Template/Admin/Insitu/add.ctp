        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading ">
                   <h4> <i class="fa fa-file-o"></i> <?= __('NUEVO REGISTRO DE ZONA DE AGROBIODIVERDSIDAD') ?></h4>
                </div>
                <?php echo $this->Form->create($insitu, [
                    'url' => ['controller' => 'Insitu', 'action' => 'add'],
                    'autocomplete' => "off",
                    'id' => "form_insitu"
                ]); ?>
                <div class="box-body">
                                                ...
                                                <div class="row">
                                                   <div class="col-lg-12"> 
                                                      ...
                                                      <?php echo $this->Form->control('observation', [
                                                        'label' => 'Observaciones', 'escape'=> false ,
                                                        'class' => 'form-control',
                                                        'type'  => 'textarea',
                                                        'rows'  => "5",
                                                     ]); ?>
                                                     <?php echo $this->Form->control('monitoring', [
                                                         'label'   => 'Monitoreo', 'escape'=> false ,
                                                        'class'   => 'form-control',
                                                             'type'    => 'select',
                                                        'options' => ['1' => 'SI', '2' => 'NO'],
                                                        'empty'   => '[ SELECCIONE ]',
                 ...
                 <div class="box-footer">
                    <div class="col-sm-12">
                        <div class="row  pull-right" >
                            <?php /*echo $this->Html->link('<i class="fa fa-times"></i> CANCELAR', ['controller'=>'Insitu', 'action' =>'index'],['class'=>'btn btn-default', ]) */?>
