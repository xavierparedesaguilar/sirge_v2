                        ...
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            <thead class="headTablaListado">
                                <tr class="text-uppercase text-center th-head-inputs">
                                    ...
                                    <th style="min-width: 120px">Cod. In Situ</th>
                                    ...
                                    <th style="min-width: 220px;"><?= __('Opciones') ?></th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <?php foreach ($insitu as $insitu): ?>
                                <tr>
                                    <td><?= $this->Number->format($insitu->id) ?></td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php if ($permiso['view']) { ?>
                                            ...
                                            <?php echo $this->Html->link('<i class="fa fa-search-plus"></i>',
                                                    ...
                                                    ['class' => 'btn btn-info btn-xs', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Ver información del In Situ."])
                                            ?>
                                        <?php } ?>
                                        ...
                                        <?php if($permiso['edit']) { ?>
                                            ...
                                            <?php echo $this->Html->link('<i class="fa fa-pencil-square-o"></i>',
                                                    ...
                                                    ['class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Editar In Situ."])
                                            ?>
                                        <?php } ?>
                                        ...
                                        <?php if($permiso['delete']) { ?>
                                            ...
                                            <?php
                                                echo $this->Html->link('<i class="fa fa-trash-o"></i>', "#",
                                                    ['class' => 'btn btn-danger btn-xs delete-btn', 'escape' => false, "data-id"=>$insitu->id, 'data-toggle' => "tooltip", 'title' => "Eliminar In Situ."])
                                            ?>
                                        <?php } ?>
                                    </td>
                                </tr>
