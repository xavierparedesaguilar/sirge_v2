            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php if($permiso['add']) { ?>
                        <?php
                            echo $this->Html->link('<i class="fa fa-plus" ></i>',['controller' => 'User', 'action' => 'add'],['class' => 'btn btn-success', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Nuevo Registro de Usuario."]);
                        ?>
                        <?php } ?>

                        <?php if($permiso['export']) { ?>

                             <button type="button" data-toggle="tooltip"  title="Exportar <?php echo $titulo ?>" id="export" class="btn btn-info waves-effect m-r-5" >
                                ...
                                <tr class="text-uppercase">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?= $this->Html->link('<i class="fa fa-search-plus"></i>',
                                                ...
                                                ['class' => 'btn btn-success btn-xs', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Ver Detalle."])
                                        ?>
                                        <?php } ?>
