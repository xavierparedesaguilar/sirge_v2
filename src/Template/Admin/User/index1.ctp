            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php if($permiso['add']) { ?>
                        <?php
                            echo $this->Html->link('<i class="fa fa-plus" ></i>',['controller' => 'User', 'action' => 'add'],['class' => 'btn btn-success', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Nuevo Usuario."]);
                        ?>
                        <?php } ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?= $this->Html->link('<i class="fa fa-search-plus"></i>',
                                                ['controller' => 'User', 'action' => 'view', $user->id],
                                                ['class' => 'btn btn-info btn-xs', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Ver información del usuario."])
                                        ?>
                                        <?php } ?>
                                        ...
                                        <?= $this->Html->link('<i class="fa fa-pencil-square-o"></i>',
                                                ...
                                                ['class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Editar el usuario."])
                                        ?>
                                        ...
                                        <?php
                                            echo $this->Html->link('<i class="fa fa-trash-o"></i>', "#",
                                                ['class' => 'btn btn-danger btn-xs delete-btn', 'escape' => false, "data-id"=>$user->id, 'data-toggle' => "tooltip", 'title' => "Eliminar el usuario."])
                                        ?>
                                        <?php } ?>
