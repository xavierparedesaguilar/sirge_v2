        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($inputDna, [
                     'novalidate',
                    'url' => ['controller' => 'InputDna', 'action' => 'add' ,'id'=>$id],
                    'class' => 'row p-10',
                    'autocomplete' => "off",
                ...
                <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-12 col-xs-12">
                                        ...
                                        <?php echo $this->Form->control('tipdep',
                                                ...
                                                'label' => 'Tipo Depósito' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Indica la categoría de deposito del adn"></i>',
                                                'escape' => false,
                    ...
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-success" id="btnInputDna">GRABAR</button>

                        <?php echo $this->Html->link('CANCELAR',
                                    ['controller' => 'InputDna', 'action' => 'index','id'=>$id],
