...
<section class="content-header">
    <h1>Módulo <?php echo $modulo ?> - Editar</h1>
       ...
       <?php
        ...
        $this->Html->addCrumb($inputDna->id, ['controller' => 'InputDna', 'action' => 'edit','id'=>$id,'child'=>$inputDna->id]);
                ...
                <div class="box-body">
                    <div class="col-xs-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                         ...
                                         <div class="col-lg-3 col-sm-12 col-xs-12">
                                            ...
                                            <?php echo $this->Form->control('tipmuestra',
                                                    ...
                                                    'label' => 'Tipo Muestra' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Indica la condicion de recepción de la muestra "></i>',
                                                    'escape' => false,
                                                    'class' => 'form-control select2',
                                                    'empty' => '-- SELECCIONE --' ]);
                                            ?>
                                            ...
                                            <?php echo $this->Form->control('estmuestra',
                                                    ...
                                                    'label' => 'Estado de la Muestra' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Indica la condicion de recepción de la muestra "></i>',
                                                    'escape' => false,
                                                    'class' => 'form-control select2',
                                                    'empty' => '-- SELECCIONE --' ]);
                                            ?>
                        ...
                        <div class="col-sm-12 text-center">
                            <button type="submit" class="btn btn-primary" id="btnInputDna">GRABAR</button>
