...
<section class="content-header">
    <h1>Módulo <?php echo $titulo ?> - Detalle</h1>
       ...
       <?php
        ...
        $this->Html->addCrumb($id, ['controller' => 'InputDna', 'action' => 'index','id'=>$id]);
        $this->Html->addCrumb('Entrada');
        $this->Html->addCrumb($inputDna->id, ['controller' => 'InputDna', 'action' => 'view','id'=>$id,'child'=>$inputDna->id]);
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-edit" ></i>',
                                    ['controller' => 'InputDna', 'action' => 'edit','id'=> $inputDna->bank_dna_id,'child'=> $inputDna->id],
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-arrow-left" ></i>',
                                    ['controller' => 'InputDna', 'action' => 'index','id'=> $inputDna->bank_dna_id],
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <!-- <tr>
                                                ...
                                                <td><?php //echo ($this->Number->format($inputDna->status)==1)? 'ACTIVO' : 'INACTIVO' ?></td>
                                            </tr>
                                            </tr>
                                            <tr>
                                                <th scope="row"><?php //echo ('Fecha Creación') ?></th>
                                                <td><?php //echo  $inputDna->created==NULL?'': date('d-m-Y H:i:s',strtotime($inputDna->created)) ?>
                                            </td>
                                            </tr>
                                            <tr>
                                                <th scope="row"><?php //echo ('Fecha de Modificación') ?></th>
                                                <td><?php //echo  $inputDna->modified==NULL?'': date('d-m-Y H:i:s',strtotime($inputDna->modified)) ?>
                                            </td> -->
                                            </tr>
                                            <!--FIN DEL MODULO 1-->
                                        </table>
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        ...
                        <?php if($permiso['edit'] && $validar){ ?>
                           <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/fitogenetico/gestion-inventario/banco-adn/'.$inputDna->bank_dna_id.'/entrada/editar/'.$inputDna->id, true) ?>"
                        ...
                        <?php if($permiso['delete'] && $validar){ ?>
                                    <?php echo $this->Html->link('ELIMINAR', "#",
                                     ...
                                     ?>
                        <?php } ?>
                            <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/fitogenetico/gestion-inventario/banco-adn/'.$inputDna->bank_dna_id.'/entrada', true) ?>"
...
<script>
    ...
    $(".delete-btn").click(function(){
        $("#ajax_button").html('<?php echo $this->Html->link('Confirmar',
                                    ['controller' => 'InputDna', 'action' => 'delete','id'=> $inputDna->bank_dna_id,'child'=> $inputDna->id],
