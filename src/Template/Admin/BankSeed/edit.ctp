...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($bankSeed->id, ['controller' => 'BankSeed', 'action' => 'edit','id'=>$bankSeed->id]);
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="panel panel-default">      
                 <div class="panel-heading ">
                    <h4><i class="fa fa-pencil-square-o"></i> ACTUALIZACIÓN DE REGISTRO: <strong><?php echo$passport->accenumb?></strong> - LOTE <strong><?php echo$bankSeed->lotnumb;?></strong></h4>
                 </div>
                    <?php echo $this->Form->create($bankSeed, [
                         // 'novalidate',
                        'url' => ['controller' => 'BankSeed', 'action' => 'edit'],
                                            ...
                                            <div class="row">  
                                                    <div class="col-lg-8 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <button type="button" data-toggle="tooltip"   id="btnPasaporteSemilla" class="btn btn-warning btn-flat" ><i class="fa fa-search " ></i></button>
                                                            </span>
                                                            </div>
                                                        </div>                                         
                                                    </div>
                                    ...
                                    <div class="row">  
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 text-primary text-left mt-3"><strong>Peso (g) </strong></div>   
                                                <div class="col-lg-5 text-primary text-left pb-3"><strong>Cantidad de Semilla</strong></div>
                                            </div> 
                                            <div class="row">
