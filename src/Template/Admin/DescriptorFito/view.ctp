...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($descriptor->name, ['controller' => 'DescriptorFito', 'action' => 'view', 'idx' => $especie->id, 'id' => $descriptor->id ]);
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <?php } ?>
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-arrow-left"></i>',
                                ['controller' => 'DescriptorFito', 'action' => 'index', 'id' => $descriptor->specie->id], ['class' => 'btn btn-default', 'data-toggle' => "tooltip", 'title' => "Retornar al anterior.", 'escape' => false])
                        ?>
                    </div>
                    <br>
                </div>
                ...
                <div class="box-footer">
                    ...
                    <?php if ($permiso['edit']) { ?>
                        ...
                        <?php echo $this->Html->link('EDITAR', ['controller' => 'DescriptorFito', 'action' => 'edit', 'id' => $descriptor->id, 'idx' => $descriptor->specie->id], ['class' => 'btn btn-primary'] ); ?>
                    ...
                    <?php } ?>
                        ...
                        <?php echo $this->Html->link('REGRESAR', ['controller' => 'DescriptorFito', 'action' => 'index', 'id' => $descriptor->specie->id], ['class' => 'btn btn-default']) ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php $url = $this->Html->link('Confirmar', ['controller' => 'DescriptorFito', 'action' => 'delete', 'idx' => $descriptor->specie->id, 'id' => $descriptor->id], ['class' => 'btn btn-success btn-flat btnEliminar' ]) ?>
