                ...
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-plus" ></i>',
                                    ['controller' => 'BankDnaMicro', 'action' => 'add'],
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php echo $this->Html->link('<i class="fa  fa-sign-in"></i>',
                                                                        ['controller' => 'InputDnaMicro', 'action' => 'index', $bankDna->id],
                                    ...
                                    <?php echo $this->Html->link('<i class="fa  fa-sign-out"></i>',
                                                                        ['controller' => 'OutputDnaMicro', 'action' => 'index', $bankDna->id],
                                    ...
                                    <?php echo $this->Html->link('<i class="fa  fa-search-plus"></i>',
                                                                        ['controller' => 'BankDnaMicro', 'action' => 'view', $bankDna->id],
                                    ...
                                    <?php if($bankDna->Extraccion==NULL){ ?>
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-plus"></i>',
                                                                            ['controller' => 'extractionDnaMicro', 'action' => 'add','id'=> $bankDna->id],
                                    ...
                                    <?php if($bankDna->Extraccion!=NULL){ ?>
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-search-plus"></i>',
                                                                            ['controller' => 'extractionDnaMicro', 'action' => 'view','id'=> $bankDna->id,'child'=>$bankDna->Extraccion->id],
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-pencil-square-o"></i>',
                                                                        ['controller' => 'extractionDnaMicro', 'action' => 'edit','id'=> $bankDna->id,'child'=>$bankDna->Extraccion->id],
