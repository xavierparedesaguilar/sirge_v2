                ...
                <div class="box-header with-border">
                    <h3 class="box-title"><strong><?= __('DATOS GENERALES') ?></strong></h3>
                        ...
                        <?php echo $this->Form->create($bankDna, [
                             // 'novalidate',
                            'url' => ['controller' => 'BankDnaMicro', 'action' => 'add'],
                            'autocomplete' => "off",
                            'id' => "form_bankAdn",
                             // 'novalidate'
                        ]); ?>
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="form-group text">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-btn" style="padding-bottom: 18px;">
                                                        <button type="button" data-toggle="tooltip"  title="Validar Cod. PER" id="btnPasaporteAdnMicro" class="btn btn-warning btn-flat" ><i class="fa fa-search " ></i></button>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="footer">
                                <div class="col-sm-12 text-center">
                                     ...
                                     <button type="submit" class="btn btn-success" id="btnBankAdn">GRABAR</button>
