...
<section class="content-header">
    <h1>Módulo <?php echo $modulo ?> - Editar</h1>
     ...
     <?php
        ...
        $this->Html->addCrumb($child, ['controller' => 'OutputField', 'action' => 'edit','id'=>$id,'child'=>$child]);
...
<div class="content">
  ...
  <div id="tabla1" class="tab-pane in active">
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                         ...
                                         <div class="col-lg-12 col-sm-12 col-xs-12">
                                                ...
                                                'escape' => false,
                                                 'placeholder'=> false, 'escape' => false,'id'=>'descripcion','class' =>'comment', 'rows' => '5', 'cols' => '5']); ?>
                    ...
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-primary" id="btnOutputField">GRABAR</button>
