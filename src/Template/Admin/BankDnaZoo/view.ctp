...
<section class="content-header">
     ...
     <h1>Módulo <?php echo $titulo ?> - Detalle</h1>
       <?php
        ...
        $this->Html->addCrumb($bankDna->id, ['controller' => 'BankDnaZoo', 'action' => 'view','id'=>$bankDna->id]);
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo h($bankDna->remarks) ?></td>
                                                </tr>
                                                <!--FIN DEL MODULO 1-->
                                            </table>
                                        </div>
                ...
                <div class="box-footer">
                    ...
                    <?php if($permiso['edit'] && $validar){ ?>
                        <?php echo $this->Html->link('EDITAR', ['controller' => 'BankDnaZoo', 'action' => 'edit', $bankDna->id], ['class' => 'btn btn-primary'] ); ?>
                    <?php } ?>
...
<script>
    $(".delete-btn").click(function(){
        $("#ajax_button").html(' <?php echo $this->Html->link('Confirmar',
                            ['controller' => 'BankDnaZoo', 'action' => 'delete', $bankDna->id],
