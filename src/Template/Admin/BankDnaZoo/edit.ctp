...
<section class="content-header">
    <h1>Módulo <?php echo $modulo ?> - Editar</h1>
       ...
       <?php
        ...
        $this->Html->addCrumb($bankDna->id, ['controller' => 'BankDnaZoo', 'action' => 'edit','id'=>$bankDna->id]);
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <?php echo $this->Form->create($bankDna, [
                         // 'novalidate',
                        'url' => ['controller' => 'BankDnaZoo', 'action' => 'edit'],
                        'class' => 'row p-10',
                        'autocomplete' => "off",
                        'id' => "form_bankAdn",
                         // 'novalidate'
                                        ...
                                        <div class="form-group text">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn" style="padding-bottom: 18px;">
                                                    <button type="button" data-toggle="tooltip"  title="Validar Cod. PER" id="btnPasaporteAdnZoo" class="btn btn-warning btn-flat" ><i class="fa fa-search " ></i></button>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
