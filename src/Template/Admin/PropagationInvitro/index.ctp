    ...
    <div class="row">
                ...
                <div class="box-header with-border">
                    ...
                    <?php if($permiso['add']) { ?>
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-plus" ></i>',
                                    ...
                                    ['class' => 'btn btn-success', 'data-toggle'=> "tooltip",  'title'=> "Nueva Propagación", 'escape'=>false] )
                        ?>
        ...
        <thead class="headTablaListado">
            <tr class="text-uppercase text-center th-head-inputs">
                 ...
                 <th style="min-width: 150px;">FECHA DE PROPAGACIÓN</th>
                 <th style="min-width: 150px;">PROPAGADOR</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo ($propagationInvitro->prodate == NULL || $propagationInvitro->prodate=='')? '' : date("d-m-Y", strtotime($propagationInvitro->prodate))  ?></td>
                ...
                <td class="text-center">
                    ...
                    <?php if($permiso['edit'] /*&& $validar*/ ) { ?>
                      ...
                      <a href="<?php echo $this->Url->build('/'.$this->request->url.'/editar/'.$propagationInvitro->id, true) ?>" class="btn btn-primary btn-xs" data-toggle = "tooltip" title = "Editar información de la Propagación."><i class="fa fa-pencil-square-o"></i></a>
                    ...
                    <?php if($permiso['delete'] /*&& $validar*/ ) { ?>
                     ...
                     <?php echo $this->Html->link('<i class="fa fa-trash-o"></i>', "#",
                                                ['class' => 'btn btn-danger btn-xs delete-btn', 'data-toggle' => "tooltip",'title' => "Eliminar la Salida de Material.",'escape' => false, "data-id"=>$propagationInvitro->id])
                       ?>
