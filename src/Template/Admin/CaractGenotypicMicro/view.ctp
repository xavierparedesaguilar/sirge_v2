            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php if($permiso['edit']){ ?>
                        <?php echo $this->Html->link('<i class="fa fa-edit"></i>', ['controller' => 'CaractGenotypicMicro', 'action' => 'edit', $caractGenotypic->id], ['class' => 'btn btn-primary', 'data-toggle'=> "tooltip",  'title'=> "Editar", 'escape'=>false] ); ?>
                        <?php } ?>
                        ...
                        <?php } ?>
                        <?php echo $this->Html->link('<i class="fa fa-arrow-left" ></i>', ['controller'=>'CaractGenotypicMicro', 'action'=>'index'],['class'=>'btn btn-default', 'data-toggle'=> "tooltip",  'title'=> "Regresar", 'escape'=>false]) ?>
                    </div>
                    <br>
                </div>
                <div class="box-body">
                            ...
                            <div class="col-xs-12 col-md-12 col-lg-6">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo (!empty($caractGenotypic->accenumb))? $this->Html->link('Descargar archivo',['controller' => 'CaractGenotypicMicro', 'action' => 'exportaraccenumb', 'id' => $caractGenotypic->id]) : '' ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo (!empty($caractGenotypic->datamatrix))? $this->Html->link('Descargar archivo',['controller' => 'CaractGenotypicMicro', 'action' => 'exportardatamatrix', 'id' => $caractGenotypic->id]) : '' ?></td>
                                    </tr>
                                    <tr>
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        ...
                        <?php echo $this->Html->link('EDITAR', ['controller' => 'CaractGenotypicMicro', 'action' => 'edit', $caractGenotypic->id], ['class' => 'btn btn-primary'] ); ?>
                        ...
                        <?php echo $this->Html->link('REGRESAR', ['controller'=>'CaractGenotypicMicro', 'action'=>'index'],['class'=>'btn btn-default']) ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php $url = $this->Html->link('Confirmar', ['controller' => 'CaractGenotypicMicro', 'action' => 'delete', 'id' => $caractGenotypic->id], ['class' => 'btn btn-success btn-flat btnEliminar' ]) ?>
