        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($extractionDna, [
                             // 'novalidate',
                            'url' => ['controller' => 'ExtractionDnaZoo', 'action' => 'add' ,'id'=>$id],
                            'autocomplete' => "off",
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-lg-3 col-sm-12 col-xs-12">
                                                            ...
                                                            <?php echo $this->Form->control('dnaqty', [
                                                                        'label' => ['text' => 'Cantidad de ADN' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Indica la cantidad  total del adn extraído"></i>'],
                                                                        'escape' => false,
                                                                        'class' => 'form-control',
                                                            ]); ?>
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        ...
                        <?php echo $this->Html->link('VOLVER',
                                                      ['controller' => 'BankDnaZoo', 'action' => 'edit', $extractionDna->bank_dna_id],
