...
<?php
    ...
    $icons = array( '7'  => array('img' => $this->Html->image('icons/pasaporte.png', ['class' => "img-rounded", 'height' => '75'])),
                    '8'  => array('img' => $this->Html->image('icons/caracterizacion.png', ['class' => "img-rounded", 'height' => '75'])),
                    '12' => array('img' => $this->Html->image('icons/inventario.png', ['class' => "img-rounded", 'height' => '75'])),
                    '18' => array('img' => $this->Html->image('icons/reportes.png', ['class' => "img-rounded", 'height' => '75'])),
                    '21' => array('img' => $this->Html->image('icons/mapas.png', ['class' => "img-rounded", 'height' => '75'])),
                );
?>
