...
<?php
    ...
    $icons = array( '9'  => array('img' => $this->Html->image('icons/genotipica.png', ['class' => "img-rounded", 'height' => '75'])),
                    '10' => array('img' => $this->Html->image('icons/fenotipica.png', ['class' => "img-rounded", 'height' => '75'])),
                    '11' => array('img' => $this->Html->image('icons/fisicoquimica.png', ['class' => "img-rounded", 'height' => '75']))
                );
?>
