...
<?php
    ...
    $icons = array( '13' => array('img' => $this->Html->image('icons/banco_semilla.png', ['class' => "img-rounded", 'height' => '75'])),
                    '14' => array('img' => $this->Html->image('icons/banco_invitro.png', ['class' => "img-rounded", 'height' => '75'])),
                    '15' => array('img' => $this->Html->image('icons/banco_campo.png', ['class' => "img-rounded", 'height' => '75'])),
                    '16' => array('img' => $this->Html->image('icons/banco_adn.png', ['class' => "img-rounded", 'height' => '75'])),
                );
?>
