            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <?php if ($permiso['add']) { ?>
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-plus"></i>',['controller' => 'DescriptorStateFito', 'action' => 'add', 'idy' => $descriptor->specie_id, 'idx' => $descriptor->id], ['class' => 'btn btn-success','data-toggle' => "tooltip", 'title' => "Agregar nuevo estado de descriptor.", 'escape' => false] ); ?>
