                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                     ...
                     <?php if($permiso['export']) { ?>
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-cloud-download"></i>', ['controller' => 'FenotipicaFito', 'action' => 'exportardescriptores'], ['class' => 'btn btn-warning', 'data-toggle' => "tooltip", 'title' => "Descargar plantilla de estados de descriptores.", 'escape' => false] ); ?>
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <?php echo $this->Html->link('<i class="fa fa-cloud-download"></i>', ['controller' => 'FenotipicaFito', 'action' => 'exportarestados'], ['class' => 'btn btn-warning', 'data-toggle' => "tooltip", 'title' => "Descargar plantilla de estados de descriptores.", 'escape' => false] ); ?>
                    </div>
                </div>
                <div class="box-body">
                    <div class="row">
