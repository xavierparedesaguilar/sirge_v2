...
<?php
    ...
    $icons = array( '43' => array('img' => $this->Html->image('icons/publicaciones.png', ['class' => "img-rounded", 'height' => '75'])),
                    '44' => array('img' => $this->Html->image('icons/catalogo.png',      ['class' => "img-rounded", 'height' => '75'])),
                    '48' => array('img' => $this->Html->image('icons/clientes.png',      ['class' => "img-rounded", 'height' => '75'])),
                );
