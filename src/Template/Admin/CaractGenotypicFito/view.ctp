...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($caractGenotypic->expnumb, [ 'controller' => 'CaractGenotypicFito', 'action' => 'view', 'id' => $caractGenotypic->id ]);
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        ['controller' => 'CaractGenotypicFito', 'action' => 'edit', $caractGenotypic->id], ['class' => 'btn btn-primary', 'data-toggle'=> "tooltip",  'title'=> "Editar", 'escape'=>false] ); ?>

                        <?php } ?>

                        <?php if($permiso['delete']){ ?>

                        <?php echo $this->Html->link('<i class="fa fa-trash" ></i>', "#",['class' => 'btn btn-danger delete-btn','data-toggle'=> "tooltip",  'title'=> "Eliminar",'escape' => false, "data-id"=>$caractGenotypic->id])?>

                        <?php } ?>

                        <?php echo $this->Html->link('<i class="fa fa-arrow-left" ></i>', ['controller'=>'CaractGenotypicFito', 'action'=>'index'],['class'=>'btn btn-default', 'data-toggle'=> "tooltip",  'title'=> "Regresar", 'escape'=>false]) ?>
                    </div>
                    <br>
                </div>
                <div class="box-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <!--DATOS PRINCIPALES-->
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo (!empty($caractGenotypic->accenumb))? $this->Html->link('Descargar archivo',['controller' => 'CaractGenotypicFito', 'action' => 'exportaraccenumb', 'id' => $caractGenotypic->id]) : '' ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= h($caractGenotypic->adaptrnum) ?></td>
                                            </tr>
                                            <tr>
                                                <th scope="row"><?= __('Nro. de Iniciadores') ?></th>
                                                <td><?= h($caractGenotypic->primernum) ?></td>
                                            </tr>

                                            <tr>
                                                <th scope="row"><?= __('Matriz de Datos') ?></th>
                                                <td><?php echo (!empty($caractGenotypic->datamatrix))? $this->Html->link('Descargar archivo',['controller' => 'CaractGenotypicFito', 'action' => 'exportardatamatrix', 'id' => $caractGenotypic->id]) : '' ?></td>
                                            </tr>
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        ...
                        <?php echo $this->Html->link('EDITAR', ['controller' => 'CaractGenotypicFito', 'action' => 'edit', $caractGenotypic->id], ['class' => 'btn btn-primary'] ); ?>

                        <?php } ?>

                        <?php if($permiso['delete']){ ?>

                        <?php echo $this->Html->link('ELIMINAR', "#",['class' => 'btn btn-danger delete-btn', 'escape' => false, "data-id"=>$caractGenotypic->id])?>

                        <?php } ?>

                        <?php echo $this->Html->link('REGRESAR', ['controller'=>'CaractGenotypicFito', 'action'=>'index'],['class'=>'btn btn-default']) ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php $url = $this->Html->link('Confirmar', ['controller' => 'CaractGenotypicFito', 'action' => 'delete', 'id' => $caractGenotypic->id], ['class' => 'btn btn-success btn-flat btnEliminar' ]) ?>
