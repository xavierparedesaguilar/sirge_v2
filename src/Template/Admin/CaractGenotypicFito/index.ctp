            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-plus" ></i>',['controller'=>'CaractGenotypicFito','action'=>'add'],['class'=>'btn btn-success', 'data-toggle'=>"tooltip" , 'title'=>"Nueva Caracterización Genotípica", 'escape' => false]) ?>
                        ...
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            <thead class="headTablaListado">
                                <tr class="text-uppercase text-center th-head-inputs">
                                    ...
                                    <th style="min-width: 180px">Colección</th>
                                    ...
                                    <th style="min-width: 170px">Nº de Adaptadores</th>
                                    <th style="min-width: 150px">Nº de Iniciadores</th>
                                    ...
                                    <th style="min-width: 150px">N° de Ciclos</th>
                                    ...
                                    <th style="min-width: 165px">N° de Repeticiones</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-search-plus"></i>',
                                                ['controller' => 'CaractGenotypicFito', 'action' => 'view', $caractGenotypic->id],
                                        ...
                                        <?php echo $this->Html->link('<i class="fa fa-pencil-square-o"></i>',
                                                ['controller' => 'CaractGenotypicFito', 'action' => 'edit', 'id' => $caractGenotypic->id],
