            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-edit" ></i>',
                                    ['controller' => 'extractionDna', 'action' => 'edit', 'id'=>$extractionDna->bank_dna_id],
                ...
                <div class="box-body">
                 ...
                 <div class="box-footer">
                    ...
                    <?php if($permiso['edit']) { ?>
                        <?php echo $this->Html->link('EDITAR', ['controller' => 'extractionDna', 'action' => 'edit', 'id'=>$extractionDna->bank_dna_id], ['class' => 'btn btn-primary'] ); ?>
