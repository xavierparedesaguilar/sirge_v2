        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li><a href="#tab_1" data-toggle="tab"><strong>Configurar Datos Pasaporte</strong></a></li>
                    <li class="active"><a href="#tab_2" data-toggle="tab"><strong>Configurar Caracterización</strong></a></li>
                </ul>
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-footer">
                                ...
                                <div class="col-sm-12 text-center">
                                    <?php echo $this->Form->button('GRABAR',['class'=>'btn btn-success']) ?>
                                    <?php echo $this->Html->link('CANCELAR', ['controller' => 'GestionPublicacionCatalogo', 'action' => 'index'],['class'=>'btn btn-default', ]) ?>
                                </div>
                                <?= $this->Form->end() ?>
                            </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <?php  if($descriptores->count() > 0){  ?>
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" id="check_caract_all" <?php echo (count($descriptores->toarray()) == count($list_catalagos))? 'checked="checked"' : ''; ?> >
                                                        <span class="text">Seleccionar todos los campos</span>
                                                    </label>
                                                </div>
                                                <?php echo $this->Form->create(NULL, [
                                                ...
                                                <?php echo $this->Form->control('resource_id', ['type'   => 'hidden', 'value' => $recurso_id]) ?>
                                                <?php echo $this->Form->control('collection_id', ['type' => 'hidden', 'value' => $coleccion_id]) ?>
                                                <?php echo $this->Form->control('specie_id', ['type'     => 'hidden', 'value' => $especie_id]) ?>
...
<script>
    $(function(){
        ...
        $("#catalogo_recurso, #catalogo_coleccion, #catalogo_especie").val(null).trigger("change");
