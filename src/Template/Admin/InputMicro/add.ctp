            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <?php echo $this->Form->create($inputMicro, [
                         // 'novalidate',
                        'url' => ['controller' => 'InputMicro', 'action' => 'add' ,'id'=>$id],
                        'class' => 'row p-10',
                        'autocomplete' => "off",
                        'id' => "form_inputMicro",
                         // 'novalidate'
                ...
                <div class="box-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <?php echo $this->Form->control('numtubent', [
                                                            'label' => ['text' => 'Número de Tubos' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Numero de tubos/viales que entran de una muestra de microorganismo"></i>'],
                                                            'escape' => false,
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                                ...
                                                <?php echo $this->Form->control('tipdep',
                                                        ...
                                                        'label' => 'Tipo Depósito' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Indica la categoría de deposito del microorganismo"></i>',
                                                        'escape' => false,
                    ...
                    <div class="col-sm-12 text-center">
                            <button type="submit" class="btn btn-success" id="btnInputMicro">GRABAR</button>
