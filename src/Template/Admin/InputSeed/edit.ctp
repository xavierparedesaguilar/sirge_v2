            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-xs-12">
                                                ...
                                                <?php echo $this->Form->control('numtubent', [
                                                            'label' => ['text' => 'Número de Semillas' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Número de tubo que entran de una accesión"></i>'],
                                                            'escape' => false,
                                                            'class' => 'form-control',
                                                ]); ?>
                    ...
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-primary" id="btnInputSeed">GRABAR</button>
