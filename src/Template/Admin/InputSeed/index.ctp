                        ...
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            <thead class="headTablaListado">
                                <tr class="text-uppercase text-center th-head-inputs">
                                     ...
                                     <th style="min-width: 165px;">CÓDIGO DE ACCESIóN DEL DONANTE</th>
                                     <th style="min-width: 160px;">FECHA DE ENTRADA</th>
                                     <th style="min-width: 150px;">PESO DE LA SEMILLA</th>
                                     <th style="min-width: 170px;">NUM. DE SEMILLAS</th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($inputSeed as $inputSeed): ?>
                                     <tr>
                                        ...
                                        <td><?= empty($inputSeed->enterdate)? '' : date("d-m-Y", strtotime($inputSeed->enterdate))  ?></td>
                                        <td><?= h($inputSeed->weightent) ?></td>
                                        <td><?= h($inputSeed->numtubent) ?></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?php echo $this->Url->build('/'.$this->request->url.'/editar/'.$inputSeed->id, true) ?>" class="btn btn-primary btn-xs" data-toggle = "tooltip" title = "Editar información de la Entrada de Material."><i class="fa fa-pencil-square-o"></i></a>
                                            ...
                                            <?php echo $this->Html->link('<i class="fa fa-trash-o"></i>', "#",
                                                ['class' => 'btn btn-danger btn-xs delete-btn', 'escape' => false, "data-id"=>$inputSeed->id, 'data-toggle' => "tooltip", 'title' => "Eliminar la Entrada de Material."])
                                            ?>
