            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" id="reason" <?php if ($outputInvitro->reason=='1') { echo ' checked'; } ?>>
                                 ...
                                 <div class="row">
                                         ...
                                         <div class="col-lg-12 col-sm-12 col-xs-12">
                                                ...
                                                'escape' => false,
                                                 'placeholder'=> false,'disabled'=> $outputInvitro->reason=='1'?false:true,'escape' => false,'id'=>'remexit','class' =>'comment', 'rows' => '5', 'cols' => '5']); ?>
                    ...
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-primary" id="btnOutputInvitro">GRABAR</button>
