    ...
    <div class="row">
        ...
        <thead class="headTablaListado">
            <tr class="text-uppercase text-center th-head-inputs">
                 <th scope="col">#</th>
                 <th style="min-width: 180px;">COD. DEL SOLICITANTE</th>
                 <th style="min-width: 180px;">NOM. DEL SOLICITANTE</th>
                 <th style="min-width: 150px;">FECHA DE SALIDA </th>

                 <th style="min-width: 170px;">NUM. DE TUBOS</th>
                 <th style="min-width: 170px;">NUM. DE EXPLANTES</th>
        ...
        <tbody>
            ...
            <?php foreach ($outputInvitro as $outputInvitro): ?>
             <tr>
                ...
                <td><?= empty($outputInvitro->exitdate)? '' : date("d-m-Y", strtotime($outputInvitro->exitdate))  ?></td>
                ...
                <td class="text-center">
                    ...
                    <?php if($permiso['edit'] /*&& $validar*/ ) { ?>
                      ...
                      <a href="<?php echo $this->Url->build('/'.$this->request->url.'/editar/'.$outputInvitro->id, true) ?>" class="btn btn-primary btn-xs" data-toggle = "tooltip" title = "Editar información de la Salida de Material."><i class="fa fa-pencil-square-o"></i></a>
                    ...
                    <?php if($permiso['delete'] /*&& $validar*/ ) { ?>
                      ...
                      <?php echo $this->Html->link('<i class="fa fa-trash-o"></i>', "#",
                                                ['class' => 'btn btn-danger btn-xs delete-btn', 'escape' => false, "data-id"=>$outputInvitro->id, 'data-toggle' => "tooltip", 'title' => "Eliminar la Salida de Material."])
                       ?>
                    <?php } ?>
