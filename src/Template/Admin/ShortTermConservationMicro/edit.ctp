...
<section class="content-header">
    ...
    <?php
        ...
        $this->Html->addCrumb($child, ['controller' => 'shortTermConservationMicro', 'action' => 'edit','id'=>$id,'child'=>$child]);
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <?php echo $this->Form->control('shortstornumb', [
                                                            'label' => ['text' => 'Código de Almacenamiento' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Código del equipo de alamacenamiento"></i>'],
                                                            'escape' => false,
                                                            'class' => 'form-control',
                                                ]); ?>
                                            </div>
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <?php echo $this->Form->control('fecha_renovacion', [
                                                            ...
                                                            'escape' => false,
                                                            'class' => 'form-control',
                                                            'value'=>$shortTermConservationMicro->renewal_date,
                                                            'id'=>'fecha_renovacion',
                                                            // 'readonly' => true
                                                ]); ?>
                                            </div>
                    ...
                    <div class="col-sm-12 text-center">
                            <button type="submit" class="btn btn-primary" id="btnConservationShortMicro">GRABAR</button>
