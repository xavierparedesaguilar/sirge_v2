...
<section class="content-header">
    <h1>Validación Pasaporte Fitogenético</h1>
    ...
    <?php
        ...
        $this->Html->addCrumb('Pasaporte Fitogenético');
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create(null, [
                    'url' => ['controller' => 'ConfigTableFitogenetico', 'action' => 'index'],
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <?php $exclude = ['id', 'passport_id', 'collection_name'/*, 'ubigeo_id'*/, 'collsrcdet', 'created', 'modified','resource_id', 'accenumb', 'status', 'accimag1', 'accimag2', 'accimag3', 'accimag4', 'remarks1', 'remarks2', 'remarks3', 'remarks4']; ?>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <span class="text"><?php echo $lista_final[$column_] #$column_ ?></span>
                                            </label>
                                        </div>
                                    </div>
                                <?php endif; ?>
