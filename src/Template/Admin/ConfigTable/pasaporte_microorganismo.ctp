...
<section class="content-header">
    <h1>Validación Pasaporte Microorganismo</h1>
    ...
    <?php
        ...
        $this->Html->addCrumb('Pasaporte Microorganismo');
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create(null, [
                    'url' => ['controller' => 'ConfigTableMicroorganismo', 'action' => 'index'],
                            ...
                            <div class="widget-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <?php  $exclude = ['id', 'passport_id'/*, 'ubigeo_id'*/, 'collection_name', 'created', 'modified','resource_id', 'accenumb', 'status', 'accimag1', 'accimag2', 'accimag3', 'accimag4', 'remarks1', 'remarks2', 'remarks3', 'remarks4','eea','eeaproc','genus','commonname','colname','collsrcdet']; ?>
