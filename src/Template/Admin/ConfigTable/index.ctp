...
<?php
    ...
    $icons = array( '1' => array('group' => '1', 'img' => $this->Html->image('icons/fitogenetico.png',   ['class' => "img-rounded", 'height' => '75'])),
                    '2' => array('group' => '1', 'img' => $this->Html->image('icons/zoogenetico.png',    ['class' => "img-rounded", 'height' => '75'])),
                    '3' => array('group' => '1', 'img' => $this->Html->image('icons/microorganismo.png', ['class' => "img-rounded", 'height' => '75']))
                );
?>
