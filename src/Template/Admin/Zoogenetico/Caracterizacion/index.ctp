...
<?php
    ...
    $icons = array( '24' => array('img' => $this->Html->image('icons/genotipica.png', ['class' => "img-rounded", 'height' => '75'])),
                    '25' => array('img' => $this->Html->image('icons/fenotipica_zoo.png', ['class' => "img-rounded", 'height' => '75']))
                );
?>
