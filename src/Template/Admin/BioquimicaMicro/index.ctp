				...
				<div class="box-header with-border">
			  		...
			  		<div class="box-tools pull-right">
                        ...
                        <?php if($permiso['import']) { ?>
                            ...
                            <?php echo $this->Html->link('<i class="fa fa-cloud-upload"></i>', $this->Url->build('/' . $this->request->url . '/importar-caracterizacion', true), ['class' => 'btn btn-warning', 'data-toggle' => "tooltip", 'title' => "Importar Caracterización.", 'escape' => false] ); ?>

                        <?php } ?>

                        <?php if($permiso['import']) { ?>

			    		<?php echo $this->Html->link('<i class="fa fa-cloud-upload"></i>', $this->Url->build('/' . $this->request->url . '/importar', true), ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Importar Descriptores y Estados.", 'escape' => false] ); ?>
...
$this->Html->script(['/assets/js/global.js'], ['block' => 'script']);
