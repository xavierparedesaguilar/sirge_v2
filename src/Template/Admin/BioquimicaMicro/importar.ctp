                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <?php if($permiso['export']) { ?>
                            ...
                            <?php echo $this->Html->link('<i class="fa fa-cloud-download"></i>', ['controller' => 'BioquimicaMicro', 'action' => 'exportardescriptores'], ['class' => 'btn btn-warning', 'data-toggle' => "tooltip", 'title' => "Descargar plantilla de descriptores.", 'escape' => false] ); ?>
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12">
                            <div class="box box-success">
                                ...
                                <?php echo $this->Form->create($descriptor, [
                                    'url'         => ['controller' => 'BioquimicaMicro', 'action' => 'importar'],
                                    'autocomplete'=> "off",
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-sm-12 col-xs-12">
                                                <?php echo $this->Form->control('tipo_agrupacion', [
                                                        ...
                                                        'label'    => __('Seleccione la agrupación <b style="color:#dd4b39;">(*)</b>'), 'escape'=> false,
                                                        'class'    => 'form-control select2',
                                ...
                                <div class="box-footer">
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/microorganismo/caracterizacion/Bioquimica', true) ?>"
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12">
                            <div class="box box-success">
                                ...
                                <div class="box-footer">
                                    <div class="col-sm-12 text-center">
                                        <?php echo $this->Form->create($descriptor, [
                                              'url' => ['controller' => 'BioquimicaMicro', 'action' => 'cargar'],
                                              'autocomplete' => "off",
                                              'id' => "form_cargar_Bioquimica",
                                        ]); ?>
                                        <?php echo $this->Form->control('form_tipo', [ 'type' => 'hidden', 'value' => '1' ]) ?>
                                        ...
                                        <button type="submit" class="btn btn-success" id="btnCargaBioFinal">GRABAR</button>
                                        <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/microorganismo/caracterizacion/Bioquimica', true) ?>"
                                           class="btn btn-default"> CANCELAR
                                        </a>
                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <?php if($permiso['export']) { ?>
                          ...
                          <?php echo $this->Html->link('<i class="fa fa-cloud-download"></i>', ['controller' => 'BioquimicaMicro', 'action' => 'exportarestados'], ['class' => 'btn btn-warning', 'data-toggle' => "tooltip", 'title' => "Descargar plantilla de estados de descriptores.", 'escape' => false] ); ?>
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-footer">
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <?php echo $this->Form->control('colection_id',[ 'type'=> 'hidden', 'value' => $model_specie->collection_id ]); ?>
                                        <?php echo $this->Form->control('tipo_agrupacion', [ 'type' => 'hidden', 'value' => $tipo_agrupacion ]) ?>
                                        <button type="submit" class="btn btn-success" id="btnCargaStateBioFinal">GRABAR</button>
                                        <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/microorganismo/caracterizacion/Bioquimica', true) ?>"
                                           class="btn btn-default"> CANCELAR
                                        </a>
