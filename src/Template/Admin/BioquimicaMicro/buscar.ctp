...
<section class="content-header">
    ...
    <?php
        $this->Html->addCrumb('Recursos Microorganismo', '/admin/microorganismo');
        $this->Html->addCrumb('Caracterización','/admin/microorganismo/caracterizacion');
        $this->Html->addCrumb('Bioquímica');
			...
			<div class="box box-success">
				<div class="box-header with-border">
                    ...
                    <?php if($permiso['import']) { ?>
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-cloud-upload"></i>', ['controller' => 'BioquimicaMicro', 'action' => 'importarCaracterizacion'], ['class' => 'btn btn-warning', 'data-toggle' => "tooltip", 'title' => "Importar Caracterización.", 'escape' => false]) ?>

                    <?php } ?>

                     <?php if($permiso['import']) { ?>

			    		<?php echo $this->Html->link('<i class="fa fa-cloud-upload"></i>', ['controller' => 'BioquimicaMicro', 'action' => 'importar'], ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Importar Descriptores y Estados.", 'escape' => false] ); ?>
                ...
                <?php echo $this->Form->create(NULL, [
                            'url' => ['controller' => 'BioquimicaMicro', 'action' => 'index'],
                            'id'  => 'form_fenotipica',
                ]); ?>
				<div class="box-body">
			  		<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="box-footer">
                    <div class="col-sm-12 text-center">
                        ...
                        <a href = "<?php echo $this->Url->build('/' . $this->Functions->getUrlFirst($this->request->url, 0).'/bioquimica/caracterizacion/', true) ?>"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php echo $this->Html->link('Descriptores',
                                                ['controller' => 'DescriptorBioquimica', 'action' => 'index', 'id' => $specie->id],
                                        ...
                                        <?php echo $this->Html->link('Caracterización',
                                                ['controller' => 'DescriptorBioquimica', 'action' => 'caracterizacion', 'idx'=> $specie->id, 'idy' => $specie->collection->id ],
