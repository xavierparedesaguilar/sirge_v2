            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title"><strong><?= __('DATOS GENERALES') ?></strong></h3>
                     ...
                     <?php echo $this->Form->create($evaluationField, [
                         // 'novalidate',
                        'url' => ['controller' => 'EvaluationField', 'action' => 'add' ,'id'=>$id],
                        'class' => 'row p-10',
                        'autocomplete' => "off",
                ...
                <div class="box-body">
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <?php echo $this->Form->control('fecha_evaluacion', [
                                                            ...
                                                            'escape' => false,
                                                            'class' => 'form-control',
                                                            'value' => $evaluationField->fecha_evaluacion,
                                                            // 'readonly' => true
                                                ]); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <?php echo $this->Form->control('prodtype',
                                                        ...
                                                        'label' => __('Tipo de Producto' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Tipo de producción cientifica - técnica"></i>'),
                                                        'escape' => false,
                                                        'class' => 'form-control',
                                                        'empty' => '-- SELECCIONE --' ]);
                                                ?>
                    ...
                    <div class="col-sm-12 text-center">
                        <button type="submit" class="btn btn-success" id="btnEvaluationField">GRABAR</button>
