...
<section class="content-header">
    <h1>Modulo <?php echo $mod_child?></h1>
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Registros de la lista  <strong><?php echo ucwords($this->Functions->Minu($titulo)) ?></strong></h3>
                    <div class="pull-right box-tools">

                        <?php if($permiso['add']) { ?>

                            <a href="<?php echo $this->Url->build('/' . $this->request->url . '/crear', true) ?>" data-tamanio="md" class="btn btn-success" data-toggle="tooltip" title="Nueva Registro" data-target="#openModal"><i class="fa fa-plus" ></i></a>

                        <?php } ?>

                        <?php if($permiso['export']) { ?>

                            <button type="button" data-toggle="tooltip" title="Exportar Listado de <?php echo ucwords($this->Functions->Minu($titulo)) ?>" id="export" class="btn btn-info" >
                    ...
                    <div class="table-responsive" id="resultado_filtro">
                        ...
                        <table id="tablaListado" class="table table-striped table-bordered table-hover ">
                            ...
                            <tr class="text-uppercase text-center th-head-inputs">
                                ...
                                <th style="min-width: 100px;">CANTIDAD/VALORES</th>
                            ...
                            foreach ($listas as $lista) : ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo ($lista->status == 1)? 'SI' : 'NO' ?></td>
                                    <td class="text-center">
                                        <a href="<?php echo $this->Url->build('/' . $this->request->url . '/categoria/' . $lista->id, true) ?>"
