        ...
        <table class="table-wrapper" role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="768" style="margin: auto;" class="email-container">
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 87px 40px 40px 40px; text-align: center; font-size: 15px; line-height: 20px; color: #555555;">
                    <p style="margin-bottom: 50px;font-size: 1.2em;color: #ffffff;background: #2a794f;padding: 20px 17px;border-radius: 10px;line-height: 22px;letter-spacing: 0px;">"Gracias por registrarse en el sistema de Información de Recursos Genéticos <br> (SIRGE-INIA)."</p>
                    <!-- <h3 class="fuente" style="font-size:21px;letter-spacing:2px;margin-bottom:5px;margin-top:30px"> -->
                    <h1 class="fuente" style="font-size:30px">BIENVENIDO</h1>
                    <h3 class="fuente" style="font-size:21px;letter-spacing:2px;margin-bottom:5px;margin-top:30px"><?php echo $name ?></h3>

                    Su usuario es <b style="color: black;font-size: 17px;"><?php echo $username ?></b><br>
                    Para volver a nuestra web dar click en el siguiente enlace <a href="https://drgb.inia.gob.pe"> drgb.inia.gob.pe</a>.
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="stack-column-center td-footer" style="color:#fff;padding: 5px 20px;text-align:left;font-size: 16px;font-style: italic;margin-bottom: 13px;">
                                    240-2100 / 240-2350 / 349-2600<br>informes@drgb.inia.gob.pe
                                </td>
                            </tr>
                        </tbody>
                    </table>
